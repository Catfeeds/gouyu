...
class ItemRefundChangeModel extends Model
{
	...
	{
		$fields = $fields ? $fields : 'item_refund_change_id, tp_order.order_id, item_ids, refund_money, reason, proof, state, ' . $this->tableName . '.addtime, handle_time, order_sn, pay_amount, tp_order.total_amount, tp_order.express_fee, ' . $this->tableName . '.admin_remark';
