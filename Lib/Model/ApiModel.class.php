...
class ApiModel extends Model
{
	...
	public $key = '@J4*A9N7&B^A9Y7j6sWv8m6%q_p+z-h=';
	...
	static function checkPHPSESSID($PHPSESSID, $func_code)
	{
		...
		$api_name = $api_name[2];
		if ($api_name != 'login' && $api_name != 'register' && $api_name != 'checkMobileRegistered' && $api_name != 'sendVerifyCode' && $api_name != 'findPassword' && $api_name != 'checkVerifyCodeValid' && $api_name != 'signin' && $api_name != 'signup' && $api_name != 'getPayInfoByOrderId')
		{
			if(!session('user_id'))
			{
