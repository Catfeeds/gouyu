...
class ClassModel extends Model
{
    ...
    public function delClass()
    {
        ...
        return $this->where('class_id = ' . $this->class_id)->delete();
    }
    ...
    public function setClass($class_id, $arr_class)
    {
        ...
        return $this->where('class_id = ' . $class_id)->save($arr_class);
    }
    ...
    public function getClass($class_id, $fields = null)
    {
        ...
        return $this->field($fields)->where('class_id = ' . $class_id)->find();
    }
    ...
    {
        if (!is_numeric($class_id))   return false;
        return $this->where('class_id = ' . $class_id)->getField($field);
    }
