...
/*TRUNCATE TABLE tp_guess;*/
TRUNCATE TABLE tp_guess_champion;
TRUNCATE TABLE tp_guess_champion_team;
TRUNCATE TABLE tp_guess_champion_user;
TRUNCATE TABLE tp_guess_field;
TRUNCATE TABLE tp_guess_field_question;
TRUNCATE TABLE tp_guess_question;
TRUNCATE TABLE tp_guess_user;
TRUNCATE TABLE tp_draw_prize;
TRUNCATE TABLE tp_roll_award;
TRUNCATE TABLE tp_roll_user;
TRUNCATE TABLE tp_order_address;
/*TRUNCATE TABLE tp_prize;
TRUNCATE TABLE tp_roll;
TRUNCATE TABLE tp_game;
TRUNCATE TABLE tp_team;*/
/*TRUNCATE TABLE tp_treasure;*/
TRUNCATE TABLE tp_treasure_user;
TRUNCATE TABLE tp_user_game;
TRUNCATE TABLE tp_user_recharge;
