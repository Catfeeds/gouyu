...
function change_change_type($change_type) 
{
        ...
        switch ($change_type) 
        {
            case 1: $change_type = '在线充值'; break;
            case 2: $change_type = '银行汇入'; break;
            case 3: $change_type = '手动录入'; break;
            case 4: $change_type = '支付宝付款'; break;
            case 5: $change_type = '订单消费'; break;
            case 6: $change_type = '手动扣款'; break;
            default:    break;
        }
        return $change_type;
}
...
{
    if(preg_match('/^(0|86|17951)?(13[0-9]|15[012356789]|17[0-9]|18[0-9]|14[57])[0-9]{8}$/',$mobile))
    {
        return true;
    }
    else
...
/****七牛图片上传 start*****/
    // 获取上传的token
    // @author wsq
    function get_qiniu_uploader_up_token($bucket='images')
    {
        Vendor('qiniu.rs');
        Vendor('qiniu.io');
        // 用于签名的公钥和私钥
    ...
    {
        $image_domain = $image_domain ? $image_domain : C('IMG_DOMAIN');
        if (!$key) false;
