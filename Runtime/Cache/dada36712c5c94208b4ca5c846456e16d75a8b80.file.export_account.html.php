<?php /* Smarty version Smarty-3.1.6, created on 2016-09-09 13:41:25
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpFinance/export_account.html" */ ?>
<?php /*%%SmartyHeaderCode:171364211357d24b857458c2-77712613%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dada36712c5c94208b4ca5c846456e16d75a8b80' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpFinance/export_account.html',
      1 => 1471252523,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '171364211357d24b857458c2-77712613',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57d24b859e928',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d24b859e928')) {function content_57d24b859e928($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<link rel="stylesheet" href="/Public/Css/acp/AcpFinance/export_data.css" type="text/css" />
...
<form action="" method="post" >
	<div class="tables-searchbox">
		...
		<input type="text" id="start_time" name="start_time" value="<?php echo $_smarty_tpl->tpl_vars['start_time']->value;?>
" autocomplete="off" class="Wdate" onclick="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss'})">  
		<span class="fi-text">-</span>  
		<input type="text" id="end_time"name="end_time" value="<?php echo $_smarty_tpl->tpl_vars['end_time']->value;?>
" autocomplete="off" class="Wdate" onclick="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss'})"> 
...
<div class="t-his-mid">
	<?php if ($_smarty_tpl->tpl_vars['count']->value){?>
		<div class="t-his-mid-a">
			<span>当前条件筛选财务数据条数为：<?php echo $_smarty_tpl->tpl_vars['count']->value;?>
条。</span>
			<a href="<?php echo $_smarty_tpl->tpl_vars['export_url']->value;?>
" class="btn btn-green" id="export">
			<i class="gicon-check white"></i>导出订单</a>
		</div>
	<div class="t-his-mid-b">该操作可以导出指定的交易记录到EXCEL文件供您下载。 为安全起见，当您离开当前页面后，本次导出的文件将被清除。</div>
	<?php }else{ ?>
	<div class="t-his-mid-b">对不起,暂时没有您要导出的数据!</div>
	<div class="t-his-mid-b">该操作可以导出指定的交易记录到EXCEL文件供您下载。 为安全起见，当您离开当前页面后，本次导出的文件将被清除。</div>
	<?php }?>
	
	<?php if ($_smarty_tpl->tpl_vars['zip_url']->value){?>
	 <div class="t-his-mid-c">
		<b>
			<img src="/Public/Images/acp/yas.jpg" /></b>
			<span><?php echo $_smarty_tpl->tpl_vars['zip_name']->value;?>
</span>
			<a href="<?php echo $_smarty_tpl->tpl_vars['zip_url']->value;?>
" class="btn btn-green"><i class="gicon-check white"></i>导出成功,请下载</a>
		</div>
	<?php }?>
