<?php /* Smarty version Smarty-3.1.6, created on 2016-08-29 16:29:47
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpClass/add_level_one.html" */ ?>
<?php /*%%SmartyHeaderCode:754096757b28a0533d575-91243367%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a9aa2212368c9dc6ed10f38071167ce90bb86a44' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpClass/add_level_one.html',
      1 => 1472004167,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '754096757b28a0533d575-91243367',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b28a054e76b',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b28a054e76b')) {function content_57b28a054e76b($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="xlarge" name="class_name" id="class_name" value="<?php echo $_smarty_tpl->tpl_vars['question_class_info']->value['class_name'];?>
">  
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="xlarge" name="serial" id="serial" value="<?php echo $_smarty_tpl->tpl_vars['question_class_info']->value['serial'];?>
">  
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
<div class="formitems inline" id="pic">
    <label class="fi-name">分类图标：</label>  
    <div class="form-controls">
        <div  id="class_icon">
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            ...
            <label><input type="radio" name="is_index" value="0" checked="checked" />否</label>   
        </div>  
    </div>  
</div>
-->
