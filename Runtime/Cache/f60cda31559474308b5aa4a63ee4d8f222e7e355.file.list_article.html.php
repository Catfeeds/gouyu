<?php /* Smarty version Smarty-3.1.6, created on 2016-08-15 18:07:54
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpArticle/list_article.html" */ ?>
<?php /*%%SmartyHeaderCode:10062401357b1947a35c277-24731323%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f60cda31559474308b5aa4a63ee4d8f222e7e355' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpArticle/list_article.html',
      1 => 1471252521,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '10062401357b1947a35c277-24731323',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57b1947a502d0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57b1947a502d0')) {function content_57b1947a502d0($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
">
        ...
        <div class="t-list">
            ...
            <select class="small" name="sort_id" id="sort_id">  
				...
				<?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['article_category_options']->value,'selected'=>$_smarty_tpl->tpl_vars['article_category_option_selected']->value),$_smarty_tpl);?>
...
" autocomplete="off" class="Wdate" onclick="WdatePicker({ dateFmt:'yyyy-MM-dd'})">  
    ...
    <table class="wxtables">  
        ...
        <tbody>  
		<?php if ($_smarty_tpl->tpl_vars['general_article_list']->value){?>
		<?php  $_smarty_tpl->tpl_vars['this'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['this']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['general_article_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['this']->key => $_smarty_tpl->tpl_vars['this']->value){
$_smarty_tpl->tpl_vars['this']->_loop = true;
?>
            <tr>  
                <td class="_checkbox">  
                    <input type="checkbox" class="checkbox" name="checkIds[]" value="<?php echo $_smarty_tpl->tpl_vars['this']->value['article_id'];?>
">  
                </td>  
                <td><a href="/Article/article_display/id/<?php echo $_smarty_tpl->tpl_vars['this']->value['article_id'];?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['this']->value['title'];?>
</a></td>  
                <td><?php echo $_smarty_tpl->tpl_vars['this']->value['article_sort_name'];?>
</td>  
...
" onblur="setSerial(<?php echo $_smarty_tpl->tpl_vars['this']->value['article_id'];?>
, this);" />
				</td>   
                <td>  
                    <a href="__APP__/AcpArticle/edit_article/id/<?php echo $_smarty_tpl->tpl_vars['this']->value['article_id'];?>
" class="btn" title="编辑"><i class="gicon-edit black"></i>编辑</a>   
                    <a href="javascript:;" onclick="delArticle(<?php echo $_smarty_tpl->tpl_vars['this']->value['article_id'];?>
...
"></script>
<script type="text/javascript" src="__ACPJS__/AcpArticle/article.js?version=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"></script>
