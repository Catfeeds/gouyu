<?php /* Smarty version Smarty-3.1.6, created on 2016-08-19 16:41:26
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpClass/get_level_one.html" */ ?>
<?php /*%%SmartyHeaderCode:27253012257b28a03a1a102-52563892%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c2bb3b56892fe2dee8eb1e51fb16653a89f31f37' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpClass/get_level_one.html',
      1 => 1471596085,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '27253012257b28a03a1a102-52563892',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b28a03ba00c',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b28a03ba00c')) {function content_57b28a03ba00c($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<table class="wxtables">  
 ...
 $_from = $_smarty_tpl->tpl_vars['question_class_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
    <tbody class="combo-tbody">  
        <tr>
			<td><input type="checkbox" class="checkbox" name="a[]" value="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['class_id'];?>
"></td>
			<td><?php echo $_smarty_tpl->tpl_vars['question_class']->value['class_name'];?>
</td>  
            ...
            <!--<td><?php if ($_smarty_tpl->tpl_vars['question_class']->value['is_index']==1){?>是<?php }else{ ?>否<?php }?></td>  -->
            <td>  
				<a href="/AcpClass/edit_level_one/class_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['class_id'];?>
.html" class="btn" title="修改">修改</a>  
        <a href="javascript:;" class="btn" title="删除" onclick="delete_question_class(<?php echo $_smarty_tpl->tpl_vars['question_class']->value['class_id'];?>
)">删除</a>  
            </td>  
        </tr>
    </tbody>
...
function delete_question_class(question_class_id)
{
	...
	{  
		 ...
		 {  
			 if(r)
			 {
				 $.post('/AcpClass/delete_level_one', {"class_id":question_class_id}, function(data, textStatus) 
				 {
					if (data == 'success')
					{
						alert('恭喜您，删除成功！');
					...
					{
						alert('对不起，一级分类下面存在二级分类数据关联，删除失败！');
					}
				});
			 }  
			 return true;  
	...
	{  
		 ...
		 {  
			 if(r)
			 {
				 ...
				 $.post('/AcpClass/batch_delete_level_one', {"question_class_ids":question_class_ids}, function(data, textStatus) 
				 {
					if (data == 'success')
					{
						alert('恭喜您，删除成功！');
