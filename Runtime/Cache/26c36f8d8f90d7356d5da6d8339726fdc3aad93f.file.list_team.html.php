<?php /* Smarty version Smarty-3.1.6, created on 2016-09-26 11:21:14
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpTeam/list_team.html" */ ?>
<?php /*%%SmartyHeaderCode:81954774057b2688bbd2b26-46910530%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '26c36f8d8f90d7356d5da6d8339726fdc3aad93f' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpTeam/list_team.html',
      1 => 1474860072,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '81954774057b2688bbd2b26-46910530',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b2688be17c4',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b2688be17c4')) {function content_57b2688be17c4($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
?>
    <tbody class="combo-tbody">  
        <tr>
			<td><input type="checkbox" class="checkbox" name="a[]" value="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['team_id'];?>
"></td>
			<td><?php echo (($tmp = @$_smarty_tpl->tpl_vars['question_class']->value['guess_type_name'])===null||$tmp==='' ? '--' : $tmp);?>
</td>  
            <td><img src="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['team_logo'];?>
" style="width:50px;height:50px"></td>  
            ...
            <td>  
				<a href="/AcpTeam/edit_team/team_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['team_id'];?>
.html" class="btn" title="修改">修改</a>  
                <a href="javascript:;" class="btn" title="删除" onclick="delete_question_class(<?php echo $_smarty_tpl->tpl_vars['question_class']->value['team_id'];?>
)">删除</a>  
            </td>  
        </tr>
    </tbody>
...
function delete_question_class(question_class_id)
{
	...
	{  
		 ...
		 {  
			 if(r)
			 {
				 $.post('/AcpTeam/del_team', {"team_id":question_class_id}, function(data, textStatus) 
				 {
					if (data == 'success')
					{
						alert('恭喜您，删除成功！');
	...
	{  
		 ...
		 {  
			 if(r)
			 {
				 ...
				 $.post('/AcpTeam/batch_del_team', {"question_class_ids":question_class_ids}, function(data, textStatus) 
				 {
					if (data == 'success')
					{
						alert('恭喜您，删除成功！');
