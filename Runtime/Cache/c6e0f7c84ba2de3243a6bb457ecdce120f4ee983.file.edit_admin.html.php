<?php /* Smarty version Smarty-3.1.6, created on 2016-08-24 18:01:12
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpRole/edit_admin.html" */ ?>
<?php /*%%SmartyHeaderCode:51461090957bd7068cc5c21-08883342%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c6e0f7c84ba2de3243a6bb457ecdce120f4ee983' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpRole/edit_admin.html',
      1 => 1471252521,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '51461090957bd7068cc5c21-08883342',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57bd706908cad',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57bd706908cad')) {function content_57bd706908cad($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<form action='' method='post' id='edit_admin'>
<div class="formitems inline">  
    <label class="fi-name">登录用户名：</label>  
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" name='linkman' value='<?php echo $_smarty_tpl->tpl_vars['user_info']->value['realname'];?>
' id='linkman' placeholder="" class="small"> 
        <span class="fi-help-text"></span>   
    </div>  
</div>
<div class="formitems inline">  
    <label class="fi-name">新密码：</label>  
    <div class="form-controls">  
        <input type="password" placeholder="" name='newpassword' id='newpassword' class="small">
        <span class="fi-help-text"><font>不修改则不用填写(不能少于6位)</font></span>    
    </div>  
</div>
<div class="formitems inline">  
...
' id='email' placeholder="" class="default">
        <span class="fi-help-text"></span>    
    </div>  
</div>
<div class="formitems inline">  
...
' id='mobile' placeholder="" class="default">
        <span class="fi-help-text" id='notice_mobile'><font>手机和固话至少填写一个</font></span>    
    </div>  
</div>
<div class="formitems inline">  
    <label class="fi-name">固话：</label>  
    <div class="form-controls">  
        <input type="text" name='tel' value='<?php echo $_smarty_tpl->tpl_vars['user_info']->value['tel'];?>
' id='tel' placeholder="" class="default">
        <span class="fi-help-text"></span>    
    </div>  
</div>
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">
        	<label><input type="radio" name="sex" value='0' <?php if ($_smarty_tpl->tpl_vars['user_info']->value['sex']==0){?>checked<?php }?> >女</label>  
            <label><input type="radio" name="sex" value='1' <?php if ($_smarty_tpl->tpl_vars['user_info']->value['sex']==1){?>checked<?php }?>>男</label>   
            <label><input type="radio" name="sex" value='2' <?php if ($_smarty_tpl->tpl_vars['user_info']->value['sex']==2){?>checked<?php }?> >保密</label>  
        </div>  
        <span class="fi-help-text"></span>
    </div>  
</div>
<div class="formitems inline">  
    <label class="fi-name"><span class='colorRed'>*</span>所属角色：</label>  
    <div class="form-controls">  
        <select name="group"> 
...
' <?php if ($_smarty_tpl->tpl_vars['user_info']->value['group_id']==$_smarty_tpl->tpl_vars['group_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['group_id']){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['group_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['group_name'];?>
</option>	
            <?php endfor; endif; ?> 
        </select>  
    </div>  
...
<div class="formitems inline">  
    ...
    <div class="form-controls">
    	...
    	<input type='hidden' name='uid' value='<?php echo url_jiami($_smarty_tpl->tpl_vars['user_info']->value['user_id']);?>
' />
    	<button type="submit" class="btn btn-blue" onclick='return checkEditAdmin();'><i class="gicon-ok white"></i>保存</button>  
...
<script src="__ACPJS__/AcpUser/edit_user_group.js?version=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"></script>
