<?php /* Smarty version Smarty-3.1.6, created on 2016-08-24 10:01:45
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpClass/edit_level_one.html" */ ?>
<?php /*%%SmartyHeaderCode:37948716357b6c63aaad2d2-33112429%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b659e00fc89a06cb462655aaa999b93d48b3b0d8' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpClass/edit_level_one.html',
      1 => 1472004076,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '37948716357b6c63aaad2d2-33112429',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b6c63ac7ac9',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b6c63ac7ac9')) {function content_57b6c63ac7ac9($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="xlarge" name="class_name" id="class_name" value="<?php echo $_smarty_tpl->tpl_vars['class_info']->value['class_name'];?>
">  
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="xlarge" name="serial" id="serial" value="<?php echo $_smarty_tpl->tpl_vars['class_info']->value['serial'];?>
">  
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
    ...
    <div class="form-controls">
        <div  id="class_icon">
            <ul class="fi-imgslist" style="float:left;">
                <li class="preview fi-imgslist-item pic<?php if (!$_smarty_tpl->tpl_vars['class_info']->value['class_icon']||!file_exists($_smarty_tpl->tpl_vars['class_icon_path']->value)){?> hide<?php }?>" id="preview" style="">
                    <div>
                        <img id="J_Preview" style="height: 65px;" src="<?php echo $_smarty_tpl->tpl_vars['class_info']->value['class_icon'];?>
"/>
                    </div>
                    <input type="hidden" name="class_icon" id="J_ImgUrl" data-id="<?php if ($_smarty_tpl->tpl_vars['class_info']->value['class_icon']){?><?php }?>" value="<?php echo $_smarty_tpl->tpl_vars['class_info']->value['class_icon'];?>
" />
                ...
                <li class="fi-imgslist-item<?php if ($_smarty_tpl->tpl_vars['class_icon_path']->value&&file_exists($_smarty_tpl->tpl_vars['class_icon_path']->value)){?> hide<?php }?>" id="add_li">
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="is_index" value="1" <?php if ($_smarty_tpl->tpl_vars['class_info']->value['is_index']==1){?>checked="checked"<?php }?> />是</label>  
            <label><input type="radio" name="is_index" value="0" <?php if ($_smarty_tpl->tpl_vars['class_info']->value['is_index']==0){?>checked="checked"<?php }?> />否</label>   
        </div>  
    </div>  
</div> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="isuse" value="1" <?php if ($_smarty_tpl->tpl_vars['class_info']->value['isuse']==1){?>checked="checked"<?php }?> />是</label>  
            <label><input type="radio" name="isuse" value="0" <?php if ($_smarty_tpl->tpl_vars['class_info']->value['isuse']==0){?>checked="checked"<?php }?> />否</label>   
        </div>  
    </div>  
</div>
