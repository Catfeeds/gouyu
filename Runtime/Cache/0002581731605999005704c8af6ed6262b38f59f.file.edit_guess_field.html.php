<?php /* Smarty version Smarty-3.1.6, created on 2016-10-09 17:25:54
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessField/edit_guess_field.html" */ ?>
<?php /*%%SmartyHeaderCode:82445355357b2c0650f70e8-69430412%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0002581731605999005704c8af6ed6262b38f59f' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessField/edit_guess_field.html',
      1 => 1475113156,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '82445355357b2c0650f70e8-69430412',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b2c06537f44',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b2c06537f44')) {function content_57b2c06537f44($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="Wdate" name="start_time" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['guess_field_info']->value['start_time'],'%Y-%m-%d %H:%M:%S');?>
...
<!--<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <select name="field_type" id="field_type" >
            ...
            <option value="1" <?php if ($_smarty_tpl->tpl_vars['guess_field_info']->value['field_type']==1){?>selected<?php }?>>--让分局--</option>
            <option value="2" <?php if ($_smarty_tpl->tpl_vars['guess_field_info']->value['field_type']==2){?>selected<?php }?>>--大小分局--</option>
        </select>
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="mini" name="serial" id="serial" value="<?php echo $_smarty_tpl->tpl_vars['guess_field_info']->value['serial'];?>
">  
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="isuse" value="1"  <?php if ($_smarty_tpl->tpl_vars['guess_field_info']->value['isuse']==1){?>checked<?php }?>/>是</label>  
            <label><input type="radio" name="isuse" value="0" <?php if ($_smarty_tpl->tpl_vars['guess_field_info']->value['isuse']==0){?>checked<?php }?>/>否</label>   
        </div>  
    </div>  
</div> 
