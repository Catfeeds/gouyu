<?php /* Smarty version Smarty-3.1.6, created on 2016-10-10 17:52:09
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpRollAward/list_roll_award.html" */ ?>
<?php /*%%SmartyHeaderCode:17373070157b6bae86af480-25656463%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f9826d2009d100b22f9d928d587c348a9e9b93fa' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpRollAward/list_roll_award.html',
      1 => 1476093127,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '17373070157b6bae86af480-25656463',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b6bae88eb85',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b6bae88eb85')) {function content_57b6bae88eb85($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
<!-- end tables-searchbox -->  
    <!--<div class="tables-searchbox">
        <form method="post" action="">
            ...
            <input type="text" name="roll_award_name" value="<?php echo $_smarty_tpl->tpl_vars['roll_award_name']->value;?>
">
...
<table class="wxtables">  
 ...
 $_from = $_smarty_tpl->tpl_vars['roll_award_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
    <tbody class="combo-tbody">  
        <tr>
			<td><input type="checkbox" class="checkbox" name="a[]" value="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['roll_award_id'];?>
"></td>
...
.html" class="btn" title="用户详情">用户详情</a>  
				<a href="/AcpRollAward/roll_award_detail/roll_award_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['roll_award_id'];?>
.html" class="btn" title="Roll详情">Roll详情</a>  
                <?php if (!$_smarty_tpl->tpl_vars['question_class']->value['is_deliver']){?>
                <a href="javascript:;" class="btn" title="发货" onclick="deliver_roll(<?php echo $_smarty_tpl->tpl_vars['question_class']->value['roll_award_id'];?>
)">发货</a>  
                <?php }?>
            </td>  
        </tr>
