<?php /* Smarty version Smarty-3.1.6, created on 2016-11-22 13:32:07
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpConfig/push_information.html" */ ?>
<?php /*%%SmartyHeaderCode:99551442458242bf8434677-38146145%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e796187cf1f0c6811fce6a0df34238f6670ee5b8' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpConfig/push_information.html',
      1 => 1479792725,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '99551442458242bf8434677-38146145',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_58242bf86f785',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_58242bf86f785')) {function content_58242bf86f785($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>提醒开关：</label>  
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="is_push" value="1" <?php if ($_smarty_tpl->tpl_vars['system_config']->value['IS_PUSH']==1){?>checked="checked"<?php }?> />开</label>  
            <label><input type="radio" name="is_push" value="0" <?php if ($_smarty_tpl->tpl_vars['system_config']->value['IS_PUSH']==0){?>checked="checked"<?php }?>/>关</label>   
        </div>  
    </div>  
</div>
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>推送时间：</label>  
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="Wdate" name="push_time" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['system_config']->value['PUSH_TIME'],'%H:%M:%S');?>
"  onclick="WdatePicker({ dateFmt:'H:mm:ss'})">
        <span class="fi-help-text">可能的时间误差2分钟内</span>  
    </div>  
</div>

<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>信息标题：</label>   
    <div class="form-controls">  
        <input type="text" class="xxlarge" name="push_title" value="<?php echo $_smarty_tpl->tpl_vars['system_config']->value['PUSH_TITLE'];?>
">  
        <span class="fi-help-text">一般在30字以内</span>  
    </div>    
</div>
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>信息摘要：</label>   
    <div class="form-controls">  
        <textarea  name="push_content" ><?php echo $_smarty_tpl->tpl_vars['system_config']->value['PUSH_CONTENT'];?>
</textarea>  
        <span class="fi-help-text">换行请用\n , 一般在80字以内</span>  
    </div>    
</div>
