<?php /* Smarty version Smarty-3.1.6, created on 2016-08-15 17:46:32
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpRole/list_admin.html" */ ?>
<?php /*%%SmartyHeaderCode:50604972357b18f78edf228-66208524%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2edace195b7515d3ad8928511b069b5c1629fc84' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpRole/list_admin.html',
      1 => 1471252521,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '50604972357b18f78edf228-66208524',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57b18f791819a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57b18f791819a')) {function content_57b18f791819a($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="tablesWrap">  
    <div class="tables-searchbox">  
       <form action='/AcpRole/list_admin' method='post'>
...
' <?php if ($_smarty_tpl->tpl_vars['s_group_id']->value==$_smarty_tpl->tpl_vars['group_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['group_id']){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['group_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['group_name'];?>
    ...
    <div class="tables-searchbox"> 
        <a href="/AcpRole/add_admin/mod_id/0" class="btn btn-blue"><i class="gicon-plus white"></i>添加管理员</a>  
    </div>
    ...
    <table class="wxtables">  
        ...
        <?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['row'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['row']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['row']['name'] = 'row';
$_smarty_tpl->tpl_vars['smarty']->value['section']['row']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['user_list']->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$_smarty_tpl->tpl_vars['smarty']->value['section']['row']['show'] = true;
$_smarty_tpl->tpl_vars['smarty']->value['section']['row']['max'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['row']['loop'];
$_smarty_tpl->tpl_vars['smarty']->value['section']['row']['step'] = 1;
$_smarty_tpl->tpl_vars['smarty']->value['section']['row']['start'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['row']['step'] > 0 ? 0 : $_smarty_tpl->tpl_vars['smarty']->value['section']['row']['loop']-1;
...
?> 
            <tr>  
                <td><?php echo $_smarty_tpl->tpl_vars['user_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['realname'];?>
</td>  
                <td><?php echo $_smarty_tpl->tpl_vars['user_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['group_name'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['user_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['email'];?>
</td>  
                <td><?php echo $_smarty_tpl->tpl_vars['user_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['reg_time'];?>
</td>  
                <td>  
                    <a href="/AcpRole/edit_admin/u/<?php echo url_jiami($_smarty_tpl->tpl_vars['user_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['user_id']);?>
/redirect/<?php echo $_smarty_tpl->tpl_vars['cur_url']->value;?>
" class="btn" title="修改">编辑</a>   
                </td>  
            </tr> 
         <?php endfor; endif; ?> 
         <?php }else{ ?>
         	<tr><td colspan=5>未找到符合条件的管理员用户</td></tr>
         <?php }?>  
        </tbody>  
    </table>  
    <!-- end wxtables -->  
