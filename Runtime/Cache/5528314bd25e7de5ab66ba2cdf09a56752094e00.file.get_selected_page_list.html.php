<?php /* Smarty version Smarty-3.1.6, created on 2016-08-15 17:35:30
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpPage/get_selected_page_list.html" */ ?>
<?php /*%%SmartyHeaderCode:207007590057b18ce2140184-72436436%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5528314bd25e7de5ab66ba2cdf09a56752094e00' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpPage/get_selected_page_list.html',
      1 => 1471252522,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '207007590057b18ce2140184-72436436',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57b18ce236107',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57b18ce236107')) {function content_57b18ce236107($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
?>
    <tbody class="combo-tbody">  
        <tr>
			<td><input type="checkbox" class="checkbox" name="a[]" value="<?php echo $_smarty_tpl->tpl_vars['page']->value['page_id'];?>
"></td>
			<td><?php echo $_smarty_tpl->tpl_vars['page']->value['page_name'];?>
</td>  
			<td><?php echo $_smarty_tpl->tpl_vars['page']->value['page_type_name'];?>
</td>  
            <td><img src="<?php echo $_smarty_tpl->tpl_vars['page']->value['image'];?>
" style="height:50px;width:50px;" onerror="no_pic(this);"></td>  
			<td><a href="<?php echo $_smarty_tpl->tpl_vars['page']->value['page_url'];?>
" title="点击打开"><?php echo $_smarty_tpl->tpl_vars['page']->value['page_url'];?>
</a></td>  
			<td><?php echo $_smarty_tpl->tpl_vars['page']->value['page_desc'];?>
</td>
			<td><?php echo $_smarty_tpl->tpl_vars['page']->value['version'];?>
</td>  
            <td>  
				<a href="/AcpPage/edit_page/page_id/<?php echo $_smarty_tpl->tpl_vars['page']->value['page_id'];?>
/page_type/<?php echo $_smarty_tpl->tpl_vars['page']->value['page_type'];?>
.html" class="btn" title="修改">换页面模板</a>  
            </td>  
        </tr>
    </tbody>
	<?php }
