<?php /* Smarty version Smarty-3.1.6, created on 2016-08-24 09:45:56
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpCustFlash/edit_cust_flash.html" */ ?>
<?php /*%%SmartyHeaderCode:149924219957bcfc343efac0-81541303%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '859ae44cbce90fec5ca6716dda126faf11ff2d7c' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpCustFlash/edit_cust_flash.html',
      1 => 1472003154,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '149924219957bcfc343efac0-81541303',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57bcfc3462bce',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57bcfc3462bce')) {function content_57bcfc3462bce($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
' id='title' placeholder="" class="small"> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" name='link' value='<?php echo $_smarty_tpl->tpl_vars['cust_flash_link']->value;?>
...
<div class="formitems inline">  
    ...
    <div class="form-controls">
		<input type="text" name='serial'  id='serial' value='<?php echo $_smarty_tpl->tpl_vars['serial']->value;?>
' class="small">
    	<span class="fi-help-text"></span>    
    </div>  
</div>
...
<div class="formitems inline" id="pic">
	...
	<div class="form-controls">
		<ul class="fi-imgslist">
			<li class="preview fi-imgslist-item pic<?php if (!$_smarty_tpl->tpl_vars['pic']->value||!file_exists($_smarty_tpl->tpl_vars['pic_img_path']->value)){?> hide<?php }?>" id="preview">
				<div class="pic-wrap">
					<img id="J_Preview" class="pic-preview" src="<?php echo $_smarty_tpl->tpl_vars['pic']->value;?>
" />
				</div>
				<input type="hidden" name="pic" id="J_ImgUrl" data-id="<?php if ($_smarty_tpl->tpl_vars['pic']->value){?><?php }?>" value="<?php echo $_smarty_tpl->tpl_vars['pic']->value;?>
" />
			...
			<li class="fi-imgslist-item<?php if ($_smarty_tpl->tpl_vars['pic']->value&&file_exists($_smarty_tpl->tpl_vars['pic_img_path']->value)){?> hide<?php }?>" id="add_li">
				<a href="javascript:;" class="add" title="上传一张新的图片" id="pic_uploader">+</a>
			</li>
		</ul>
		<span class="fi-help-text">
            <span style="color:red;">图片尺寸：600*320像素;<!--</span><span style="color:green;">当选择模板8时，图片尺寸：600*600像素</span>，-->暂时只支持上传单张2M以内JPEG,PNG,GIF格式图片</span>
	</div>
</div>
...
<div class="formitems inline">
	...
	<div class="form-controls">
		<div class="radio-group">
			<label><input type="radio" name="isuse" class="j-skupanelCtrl" value="1" <?php if ($_smarty_tpl->tpl_vars['isuse']->value==1||!isset($_smarty_tpl->tpl_vars['isuse']->value)){?>checked<?php }?>>是</label>
			<label><input type="radio" name="isuse" class="j-skupanelCtrl" value="0" <?php if (isset($_smarty_tpl->tpl_vars['isuse']->value)&&$_smarty_tpl->tpl_vars['isuse']->value==0){?>checked<?php }?>>否</label>
		</div>
	</div>
</div>
