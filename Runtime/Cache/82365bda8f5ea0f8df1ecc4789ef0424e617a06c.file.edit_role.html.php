<?php /* Smarty version Smarty-3.1.6, created on 2016-09-20 10:17:27
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpRole/edit_role.html" */ ?>
<?php /*%%SmartyHeaderCode:209845910857e09c3724ba30-24869933%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '82365bda8f5ea0f8df1ecc4789ef0424e617a06c' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpRole/edit_role.html',
      1 => 1471252521,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '209845910857e09c3724ba30-24869933',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57e09c374cde2',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57e09c374cde2')) {function content_57e09c374cde2($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<form method="POST" action="" name="add_role_form" id="add_role_form">
	<div class="formitems inline">  
		...
		<div class="form-controls">  
			<input type="text" name="role_name" id="role_name" placeholder="" value="<?php echo $_smarty_tpl->tpl_vars['role_info']->value['group_name'];?>
">  
			<span class="fi-help-text"></span>
		</div>  
	</div> 
	<div class="add_role_box">
		<?php  $_smarty_tpl->tpl_vars['priv_info'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['priv_info']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['priv_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['priv_info']->key => $_smarty_tpl->tpl_vars['priv_info']->value){
$_smarty_tpl->tpl_vars['priv_info']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['priv_info']->key;
?>
			<div class="add-role-list">
				<div class="add-role-tit">
					<input type="checkbox" name="checkbox" id="checkbox<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
" class="che-t"/>
					<label for="checkbox<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['priv_info']->value['name'];?>
</label>
				</div>
				<ul>
					<?php  $_smarty_tpl->tpl_vars['first_level_menu_info'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['first_level_menu_info']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['priv_info']->value['menu_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['first_level_menu_info']->key => $_smarty_tpl->tpl_vars['first_level_menu_info']->value){
$_smarty_tpl->tpl_vars['first_level_menu_info']->_loop = true;
?>
						<?php  $_smarty_tpl->tpl_vars['second_level_menu_info'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['second_level_menu_info']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['first_level_menu_info']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['second_level_menu_info']->key => $_smarty_tpl->tpl_vars['second_level_menu_info']->value){
$_smarty_tpl->tpl_vars['second_level_menu_info']->_loop = true;
?>
							<li><input type="checkbox" name="priv" id="<?php echo $_smarty_tpl->tpl_vars['second_level_menu_info']->value['id'];?>
" class="che-li" value="<?php echo $_smarty_tpl->tpl_vars['second_level_menu_info']->value['id'];?>
" <?php if (in_array($_smarty_tpl->tpl_vars['second_level_menu_info']->value['id'],$_smarty_tpl->tpl_vars['role_info']->value['priv_arr'])){?>checked<?php }?>/><label for="<?php echo $_smarty_tpl->tpl_vars['second_level_menu_info']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['second_level_menu_info']->value['name'];?>
</label></li>
						<?php } ?>
					<?php } ?>
				</ul>
		...
		<?php } ?>
		<input type="hidden" name="priv_list" id="priv_list" value="<?php echo $_smarty_tpl->tpl_vars['role_info']->value['priv_str'];?>
">
		<span class="fi-help-text"></span>
	</div>  
