<?php /* Smarty version Smarty-3.1.6, created on 2016-09-09 11:58:35
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpNotice/edit_notice.html" */ ?>
<?php /*%%SmartyHeaderCode:107266934957d2336bcbefc9-67019041%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '92c4e3dcfebb59f131ff6a98aa12472a1a2210b9' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpNotice/edit_notice.html',
      1 => 1471252520,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '107266934957d2336bcbefc9-67019041',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57d2336bf1a74',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d2336bf1a74')) {function content_57d2336bf1a74($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" placeholder="" class="xlarge" name="title" id="title" value="<?php echo $_smarty_tpl->tpl_vars['notice_data']->value['title'];?>
">  
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <select name="sort_id" id="sort_id">  
            ...
            <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['notice_category_options']->value,'selected'=>$_smarty_tpl->tpl_vars['notice_data']->value['notice_sort_id']),$_smarty_tpl);?>
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" placeholder="" name="author" id="author" value="<?php echo $_smarty_tpl->tpl_vars['notice_data']->value['author'];?>
"> 
    </div>  
</div> 
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" placeholder="" name="notice_source" id="notice_source" value="<?php echo $_smarty_tpl->tpl_vars['notice_data']->value['notice_source'];?>
"> 
    </div>  
</div> 
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" placeholder="" style="width:45px;" name="serial" id="serial" value="<?php echo $_smarty_tpl->tpl_vars['notice_data']->value['serial'];?>
"> 
    </div>  
</div>
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="isuse" value="1"<?php if ($_smarty_tpl->tpl_vars['notice_data']->value['isuse']==1){?> checked="checked"<?php }?> />是</label>  
            <label><input type="radio" name="isuse" value="0"<?php if ($_smarty_tpl->tpl_vars['notice_data']->value['isuse']==0){?> checked="checked"<?php }?> />否</label>   
        </div>  
    </div>  
</div> 
<div class="formitems inline">
	...
	<div class="form-controls">
		<ul class="fi-imgslist">
			<li class="fi-imgslist-item pic<?php if (!$_smarty_tpl->tpl_vars['notice_data']->value['path_img']){?> hide<?php }?>">
				<div class="pic-wrap">
					<img id="J_Preview" class="pic-preview" />
				</div>
				<input type="hidden" name="img_url" id="J_ImgUrl" data-id="<?php if ($_smarty_tpl->tpl_vars['notice_data']->value['path_img']){?><?php echo $_smarty_tpl->tpl_vars['notice_data']->value['notice_id'];?>
<?php }?>" value="<?php echo $_smarty_tpl->tpl_vars['notice_data']->value['path_img'];?>
" />
			...
			<li class="fi-imgslist-item<?php if ($_smarty_tpl->tpl_vars['notice_data']->value['path_img']){?> hide<?php }?>">
				<a href="javascript:;" class="add" title="上传一张新的图片" id="J_Uploader">+</a>
			</li>
		</ul>
		<span class="fi-help-text">公告列表的缩略图，暂时只支持上传单张2M以内JPEG,PNG,GIF格式图片</span>
	</div>
</div>
<div class="formitems inline">  
    <label class="fi-name">页面关键字：</label>  
    <div class="form-controls">  
        <input type="text" placeholder="" class="xlarge" name="keywords" id="keywords" value="<?php echo $_smarty_tpl->tpl_vars['notice_data']->value['keywords'];?>
"> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <textarea name="description" id="description"><?php echo $_smarty_tpl->tpl_vars['notice_data']->value['description'];?>
</textarea>   
    </div>  
</div> 
<div class="formitems inline">  
    ...
    <div class="form-controls" id="J_KindEditor">  
        <textarea name="contents" id="contents" class="large"><?php echo $_smarty_tpl->tpl_vars['notice_data']->value['contents'];?>
</textarea>
    </div>  
</div> 
<div class="formitems inline">  
...
<script charset="utf-8" src="__KD__/kindeditor.js?version=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
" > </script>
<script charset="utf-8" src="__KD__/lang/zh_CN.js?version=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
" > </script>
