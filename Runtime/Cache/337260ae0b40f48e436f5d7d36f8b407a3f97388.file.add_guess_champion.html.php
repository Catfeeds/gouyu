<?php /* Smarty version Smarty-3.1.6, created on 2016-09-19 16:32:47
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessChampion/add_guess_champion.html" */ ?>
<?php /*%%SmartyHeaderCode:66643194957b3d74e5cb696-69763761%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '337260ae0b40f48e436f5d7d36f8b407a3f97388' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessChampion/add_guess_champion.html',
      1 => 1474273930,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '66643194957b3d74e5cb696-69763761',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b3d74e74fc1',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b3d74e74fc1')) {function content_57b3d74e74fc1($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="xlarge" name="title" id="title" value="<?php echo $_smarty_tpl->tpl_vars['guess_field_info']->value['guess_field_name'];?>
">  
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="Wdate" name="end_time" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['guess_info']->value['start_date'],'%Y-%m-%d %H:%M:%S');?>
"  onclick="WdatePicker({ dateFmt:'yyyy-MM-dd H:mm:ss'})">
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
"><?php echo $_smarty_tpl->tpl_vars['province']->value['province_name'];?>
        ...
        <input type="text" placeholder="请填写具体地址" name="address" style="width:400px" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['guess_info']->value['start_date'],'%Y-%m-%d %H:%M:%S');?>
"  >
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
    ...
    <div class="form-controls">
        <div  id="img_path">
            <ul class="fi-imgslist" style="float:left;">
                <li class="preview fi-imgslist-item pic<?php if (!$_smarty_tpl->tpl_vars['team_info']->value['img_path']||!file_exists($_smarty_tpl->tpl_vars['img_path_path']->value)){?> hide<?php }?>" id="preview" style="">
                    <div>
                        <img id="J_Preview" style="height: 65px;" src="<?php echo $_smarty_tpl->tpl_vars['team_info']->value['img_path'];?>
"/>
                    </div>
                    <input type="hidden" name="img_path" id="J_ImgUrl" data-id="<?php if ($_smarty_tpl->tpl_vars['team_info']->value['img_path']){?><?php }?>" value="<?php echo $_smarty_tpl->tpl_vars['team_info']->value['img_path'];?>
" />
