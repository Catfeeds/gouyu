<?php /* Smarty version Smarty-3.1.6, created on 2016-08-17 16:48:01
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpGame/edit_game.html" */ ?>
<?php /*%%SmartyHeaderCode:127896188157b424c1483802-09166620%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '11d554cb63ad72b2c5849c95e443ef5a11ff4730' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpGame/edit_game.html',
      1 => 1471423419,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '127896188157b424c1483802-09166620',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57b424c15f4d7',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57b424c15f4d7')) {function content_57b424c15f4d7($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>游戏名称：</label>  
    <div class="form-controls">  
		<input type="text" placeholder="" class="xlarge" name="game_name" id="game_name" value="<?php echo $_smarty_tpl->tpl_vars['game_info']->value['game_name'];?>
">  
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="mini" name="serial" id="serial" value="<?php echo $_smarty_tpl->tpl_vars['game_info']->value['serial'];?>
">  
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="isuse" value="1" <?php if ($_smarty_tpl->tpl_vars['game_info']->value['isuse']==1){?>checked="checked"<?php }?> />是</label>  
            <label><input type="radio" name="isuse" value="0" <?php if ($_smarty_tpl->tpl_vars['game_info']->value['isuse']==0){?>checked="checked"<?php }?>/>否</label>   
        </div>  
    </div>  
</div> 
