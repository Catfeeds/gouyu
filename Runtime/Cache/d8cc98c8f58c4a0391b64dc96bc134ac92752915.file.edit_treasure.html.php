<?php /* Smarty version Smarty-3.1.6, created on 2017-03-03 16:39:11
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpTreasure/edit_treasure.html" */ ?>
<?php /*%%SmartyHeaderCode:19049250557b41dffbc9b62-90354436%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd8cc98c8f58c4a0391b64dc96bc134ac92752915' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpTreasure/edit_treasure.html',
      1 => 1488530314,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '19049250557b41dffbc9b62-90354436',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b41dffeb60a',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b41dffeb60a')) {function content_57b41dffeb60a($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
" <?php if ($_smarty_tpl->tpl_vars['treasure_info']->value['prize_id']==$_smarty_tpl->tpl_vars['item']->value['prize_id']){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['item']->value['prize_name'];?>
</option>
            <?php } ?>
        </select>
...
<!--<div class="formitems inline" id="pic">
    <label class="fi-name"><span class="colorRed">*</span>宝贝图片：</label>  
    <div class="form-controls">
        <div  id="img_path">
            <ul class="fi-imgslist" style="float:left;">
                <li class="preview fi-imgslist-item pic<?php if (!$_smarty_tpl->tpl_vars['treasure_info']->value['img_path']||!file_exists($_smarty_tpl->tpl_vars['img_path_path']->value)){?> hide<?php }?>" id="preview" style="">
                    <div>
                        <img id="J_Preview" style="height: 65px;" src="<?php echo $_smarty_tpl->tpl_vars['treasure_info']->value['img_path'];?>
"/>
                    </div>
                    <input type="hidden" name="img_path" id="J_ImgUrl" data-id="<?php if ($_smarty_tpl->tpl_vars['treasure_info']->value['img_path']){?><?php }?>" value="<?php echo $_smarty_tpl->tpl_vars['treasure_info']->value['img_path'];?>
" />
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="Wdate" name="start_time" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['treasure_info']->value['start_time'],'%Y-%m-%d %H:%M:%S');?>
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="Wdate" name="end_time" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['treasure_info']->value['end_time'],'%Y-%m-%d %H:%M:%S');?>
"  onclick="WdatePicker({ dateFmt:'yyyy-MM-dd H:mm:ss'})">
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>总需人次：</label>  
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="mini" name="total_person_times" value="<?php echo $_smarty_tpl->tpl_vars['treasure_info']->value['total_person_times'];?>
">
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>期数：</label>  
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="mini" name="periods" value="<?php echo $_smarty_tpl->tpl_vars['treasure_info']->value['periods'];?>
">
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>每人每天购买限额：</label>  
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="mini" name="each_person_times" value="<?php echo $_smarty_tpl->tpl_vars['treasure_info']->value['each_person_times'];?>
">
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
<div class="formitems inline">  
    <label class="fi-name">是否福利专区：</label>  
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="is_fuli" value="1" <?php if ($_smarty_tpl->tpl_vars['treasure_info']->value['is_fuli']==1){?>checked="checked"<?php }?> onclick="show_limit_fuli(1)"/>是</label>  
            <label><input type="radio" name="is_fuli" value="0" <?php if ($_smarty_tpl->tpl_vars['treasure_info']->value['is_fuli']==0){?>checked="checked"<?php }?> onclick="show_limit_fuli(0)"/>否</label>   
        </div>  
    </div>  
</div> 
<div class="formitems inline fuli_money" <?php if ($_smarty_tpl->tpl_vars['treasure_info']->value['is_fuli']==0){?>style="display:none"<?php }?>>  
    <label class="fi-name"><span class="colorRed">*</span>流水要求：</label>  
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="" name="limit_fuli_money" value="<?php echo $_smarty_tpl->tpl_vars['treasure_info']->value['limit_fuli_money'];?>
">
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="mini" name="serial" id="serial" value="<?php echo $_smarty_tpl->tpl_vars['treasure_info']->value['serial'];?>
">  
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
