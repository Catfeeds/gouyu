<?php /* Smarty version Smarty-3.1.6, created on 2016-08-19 16:45:45
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpClass/get_level_two.html" */ ?>
<?php /*%%SmartyHeaderCode:31441068557b28a08218c00-20392193%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '11d130042c53f78536ccba7309571ea8442e5db2' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpClass/get_level_two.html',
      1 => 1471596344,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '31441068557b28a08218c00-20392193',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b28a083bccc',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b28a083bccc')) {function content_57b28a083bccc($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
?>
    <tbody class="combo-tbody">  
        <tr>
			<td><input type="checkbox" class="checkbox" name="a[]" value="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['sort_id'];?>
"></td>
			<td><?php echo $_smarty_tpl->tpl_vars['question_class']->value['sort_name'];?>
</td>  
      <td><?php echo $_smarty_tpl->tpl_vars['question_class']->value['class_name'];?>
            ...
            <td>  
				<a href="/AcpClass/edit_level_two/sort_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['sort_id'];?>
.html" class="btn" title="修改">修改</a>  
        <a href="javascript:;" class="btn" title="删除" onclick="delete_question_class(<?php echo $_smarty_tpl->tpl_vars['question_class']->value['sort_id'];?>
)">删除</a>  
            </td>  
        </tr>
    </tbody>
...
function delete_question_class(question_class_id)
{
	...
	{  
		 ...
		 {  
			 if(r)
			 {
				 $.post('/AcpClass/delete_level_two', {"sort_id":question_class_id}, function(data, textStatus) 
				 {
					if (data == 'success')
					{
						alert('恭喜您，删除成功！');
	...
	{  
		 ...
		 {  
			 if(r)
			 {
				 ...
				 $.post('/AcpClass/batch_delete_level_two', {"question_class_ids":question_class_ids}, function(data, textStatus) 
				 {
					if (data == 'success')
					{
						alert('恭喜您，删除成功！');
