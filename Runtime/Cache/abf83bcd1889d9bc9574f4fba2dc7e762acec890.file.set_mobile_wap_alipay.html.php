<?php /* Smarty version Smarty-3.1.6, created on 2016-10-19 15:07:01
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpPayment/set_mobile_wap_alipay.html" */ ?>
<?php /*%%SmartyHeaderCode:154322551158071a4cba3574-81962375%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'abf83bcd1889d9bc9574f4fba2dc7e762acec890' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpPayment/set_mobile_wap_alipay.html',
      1 => 1476860708,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '154322551158071a4cba3574-81962375',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_58071a4cdd0f7',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_58071a4cdd0f7')) {function content_58071a4cdd0f7($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
">
    ...
    <div class="formitems inline">
        <label class="fi-name">开发者的app_id：</label>
        <div class="form-controls">
			<input type="text" class="xlarge" name="alipay_app_id" id="alipay_app_id" value="<?php echo $_smarty_tpl->tpl_vars['payway_info']->value['pay_config']['alipay_app_id'];?>
">
			<span class="fi-help-text">支付宝分配给开发者的应用Id</span>
        </div>
    </div>
