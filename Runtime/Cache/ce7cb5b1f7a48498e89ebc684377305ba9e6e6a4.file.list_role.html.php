<?php /* Smarty version Smarty-3.1.6, created on 2016-08-15 17:46:34
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpRole/list_role.html" */ ?>
<?php /*%%SmartyHeaderCode:68133496157b18f7a396e99-08348632%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ce7cb5b1f7a48498e89ebc684377305ba9e6e6a4' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpRole/list_role.html',
      1 => 1471252521,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '68133496157b18f7a396e99-08348632',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57b18f7a51a38',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57b18f7a51a38')) {function content_57b18f7a51a38($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
"><?php echo $_smarty_tpl->tpl_vars['action_title']->value;?>
 ...
 <div class="tables-searchbox"> 
        <a href="/AcpRole/add_role/mod_id/0" class="btn btn-blue"><i class="gicon-plus white"></i>添加角色</a>  
    </div>
<div class="tablesWrap">  
    <table class="wxtables">  
        ...
        <tbody>  
			<?php  $_smarty_tpl->tpl_vars['role_info'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['role_info']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['role_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['role_info']->key => $_smarty_tpl->tpl_vars['role_info']->value){
$_smarty_tpl->tpl_vars['role_info']->_loop = true;
?>
				<tr>  
					<td><?php echo $_smarty_tpl->tpl_vars['role_info']->value['i'];?>
</td>  
					<td><?php echo $_smarty_tpl->tpl_vars['role_info']->value['group_name'];?>
</td>  
					<td>  
						<a href="/AcpRole/edit_role/group_id/<?php echo $_smarty_tpl->tpl_vars['role_info']->value['group_id'];?>
" class="btn" title="修改">编辑</a>
						<a href="javascript:;" class="btn" title="删除" onclick="return del_confirm('/AcpRole/del_role/group_id/<?php echo $_smarty_tpl->tpl_vars['role_info']->value['group_id'];?>
');">删除</a>   
					</td>  
				</tr>
			<?php } ?>
