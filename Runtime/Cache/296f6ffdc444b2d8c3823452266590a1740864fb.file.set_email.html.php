<?php /* Smarty version Smarty-3.1.6, created on 2016-08-20 17:28:51
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpConfig/set_email.html" */ ?>
<?php /*%%SmartyHeaderCode:116292459657b7f116ae7260-38286947%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '296f6ffdc444b2d8c3823452266590a1740864fb' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpConfig/set_email.html',
      1 => 1471685330,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '116292459657b7f116ae7260-38286947',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b7f116d3e06',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b7f116d3e06')) {function content_57b7f116d3e06($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>邮箱地址：</label>  
    <div class="form-controls">  
        <input type="text" name='mail_address' value='<?php echo $_smarty_tpl->tpl_vars['system_config']->value['MAIL_ADDRESS'];?>
' class="" placeholder=""> 
...
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>邮箱登录帐号：</label>  
    <div class="form-controls">  
        <input type="text" name='mail_loginname' class="" value='<?php echo $_smarty_tpl->tpl_vars['system_config']->value['MAIL_LOGINNAME'];?>
' placeholder=""> 
        <span class="fi-help-text"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>邮箱SMTP服务器：</label>  
    <div class="form-controls">  
        <input type="text" name='mail_smtp' class="" value='<?php echo $_smarty_tpl->tpl_vars['system_config']->value['MAIL_SMTP'];?>
' placeholder=""> 
        <span class="fi-help-text"></span>
    </div>  
</div> 
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>邮箱密码：</label>  
    <div class="form-controls">  
        <input type="password" name='mail_password' class="" value='<?php echo $_smarty_tpl->tpl_vars['system_config']->value['MAIL_PASSWORD'];?>
' placeholder="">
        <span class="fi-help-text"></span>
    </div>  
</div> 
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>发件人名称：</label>  
    <div class="form-controls">  
        <input type="text" name='fromname' class="" value='<?php echo $_smarty_tpl->tpl_vars['system_config']->value['FROMNAME'];?>
' placeholder="">
        <span class="fi-help-text"></span>
    </div>  
</div> 
