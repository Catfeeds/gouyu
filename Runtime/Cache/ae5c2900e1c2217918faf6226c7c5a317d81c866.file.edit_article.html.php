<?php /* Smarty version Smarty-3.1.6, created on 2016-08-23 16:49:53
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpArticle/edit_article.html" */ ?>
<?php /*%%SmartyHeaderCode:42619804157baace2be2d11-52378431%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ae5c2900e1c2217918faf6226c7c5a317d81c866' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpArticle/edit_article.html',
      1 => 1471942192,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '42619804157baace2be2d11-52378431',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57baace2d5a73',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57baace2d5a73')) {function content_57baace2d5a73($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" placeholder="" class="xlarge" name="title" id="title" value="<?php echo $_smarty_tpl->tpl_vars['article_data']->value['title'];?>
">  
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <select name="sort_id" id="sort_id" onchange="show_rule_sort(this)">  
            ...
            <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['article_category_options']->value,'selected'=>$_smarty_tpl->tpl_vars['article_data']->value['article_sort_id']),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['article_data']->value['rule_type']==$_smarty_tpl->tpl_vars['key']->value){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['item']->value;?>
</option>
            <?php } ?>
        </select>   
		<span class="fi-help-text hide"></span>
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" placeholder="" name="author" id="author" value="<?php echo $_smarty_tpl->tpl_vars['article_data']->value['author'];?>
"> 
    </div>  
</div> 
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" placeholder="" name="article_source" id="article_source" value="<?php echo $_smarty_tpl->tpl_vars['article_data']->value['article_source'];?>
"> 
    </div>  
</div> 
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" placeholder="" style="width:45px;" name="serial" id="serial" value="<?php echo $_smarty_tpl->tpl_vars['article_data']->value['serial'];?>
"> 
    </div>  
</div>
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="isuse" value="1"<?php if ($_smarty_tpl->tpl_vars['article_data']->value['isuse']==1){?> checked="checked"<?php }?> />是</label>  
            <label><input type="radio" name="isuse" value="0"<?php if ($_smarty_tpl->tpl_vars['article_data']->value['isuse']==0){?> checked="checked"<?php }?> />否</label>   
        </div>  
    </div>  
</div> 
<div class="formitems inline">
	...
	<div class="form-controls">
		<ul class="fi-imgslist">
			<li class="fi-imgslist-item pic<?php if (!$_smarty_tpl->tpl_vars['article_data']->value['path_img']){?> hide<?php }?>">
				<div class="pic-wrap">
					<img id="J_Preview" class="pic-preview" />
				</div>
				<input type="hidden" name="img_url" id="J_ImgUrl" data-id="<?php if ($_smarty_tpl->tpl_vars['article_data']->value['path_img']){?><?php echo $_smarty_tpl->tpl_vars['article_data']->value['article_id'];?>
<?php }?>" value="<?php echo $_smarty_tpl->tpl_vars['article_data']->value['path_img'];?>
" />
			...
			<li class="fi-imgslist-item<?php if ($_smarty_tpl->tpl_vars['article_data']->value['path_img']){?> hide<?php }?>">
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" placeholder="" class="xlarge" name="keywords" id="keywords" value="<?php echo $_smarty_tpl->tpl_vars['article_data']->value['keywords'];?>
"> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <textarea name="description" id="description"><?php echo $_smarty_tpl->tpl_vars['article_data']->value['description'];?>
</textarea>   
    </div>  
</div> 
<div class="formitems inline">  
    ...
    <div class="form-controls" id="J_KindEditor">  
        <script id="editor" name="contents" type="text/plain" style="width:700px;height:500px;"><?php echo $_smarty_tpl->tpl_vars['article_data']->value['contents'];?>
</script>
    </div>  
</div>
<div class="formitems inline">  
...
var sort_id = parseInt('<?php echo $_smarty_tpl->tpl_vars['article_data']->value['article_sort_id'];?>
'); 
