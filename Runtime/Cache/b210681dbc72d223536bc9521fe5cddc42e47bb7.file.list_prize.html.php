<?php /* Smarty version Smarty-3.1.6, created on 2016-08-18 09:36:56
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpPrize/list_prize.html" */ ?>
<?php /*%%SmartyHeaderCode:103871798257b50b8c954e48-54758666%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b210681dbc72d223536bc9521fe5cddc42e47bb7' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpPrize/list_prize.html',
      1 => 1471484104,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '103871798257b50b8c954e48-54758666',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b50b8cb99d0',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b50b8cb99d0')) {function content_57b50b8cb99d0($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
?>
    <tbody class="combo-tbody">  
        <tr>
			<td><input type="checkbox" class="checkbox" name="a[]" value="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['prize_id'];?>
"></td>
            <td><img src="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['img_path'];?>
" onerror="no_pic(this)" style="width:50px;heigh:50px;"/></td>  
            ...
            <td>  
				<a href="/AcpPrize/edit_prize/prize_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['prize_id'];?>
.html" class="btn" title="修改">修改</a>  
                <a href="javascript:;" class="btn" title="删除" onclick="delete_question_class(<?php echo $_smarty_tpl->tpl_vars['question_class']->value['prize_id'];?>
)">删除</a>  
            </td>  
        </tr>
    </tbody>
...
function delete_question_class(question_class_id)
{
	...
	{  
		 ...
		 {  
			 if(r)
			 {
				 $.post('/AcpPrize/del_prize', {"prize_id":question_class_id}, function(data, textStatus) 
				 {
					if (data == 'success')
					{
						alert('恭喜您，删除成功！');
	...
	{  
		 ...
		 {  
			 if(r)
			 {
				 ...
				 $.post('/AcpPrize/batch_del_prize', {"question_class_ids":question_class_ids}, function(data, textStatus) 
				 {
					if (data == 'success')
					{
						alert('恭喜您，删除成功！');
