<?php /* Smarty version Smarty-3.1.6, created on 2016-08-19 16:22:41
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpRollUser/list_roll_user.html" */ ?>
<?php /*%%SmartyHeaderCode:147871888657b6c1d149bca9-17220428%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '00b5d9be2dce67ad941eeb96969cc9e23857b0d9' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpRollUser/list_roll_user.html',
      1 => 1471594943,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '147871888657b6c1d149bca9-17220428',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57b6c1d174878',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57b6c1d174878')) {function content_57b6c1d174878($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
?>
    <tbody class="combo-tbody">  
        <tr>
			<td><input type="checkbox" class="checkbox" name="a[]" value="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['roll_user_id'];?>
"></td>
			...
			<td><?php echo smarty_modifier_DATE_FORMAT($_smarty_tpl->tpl_vars['question_class']->value['addtime'],"%Y-%m-%d %H:%M:%S");?>
</td>  
            <!--<td>  
				<a href="/AcpRollUser/edit_roll_user/roll_user_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['roll_user_id'];?>
.html" class="btn" title="修改">修改</a>  
                <a href="javascript:;" class="btn" title="删除" onclick="delete_question_class(<?php echo $_smarty_tpl->tpl_vars['question_class']->value['roll_user_id'];?>
)">删除</a>  
                </td>-->  
        </tr>
    </tbody>
