<?php /* Smarty version Smarty-3.1.6, created on 2016-09-22 15:47:34
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpConfig/close_recharge.html" */ ?>
<?php /*%%SmartyHeaderCode:199578484357b8028032a5f6-08991249%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ded71faa0fc036c02c52e8be7eec302cf80efb9f' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpConfig/close_recharge.html',
      1 => 1474530337,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '199578484357b8028032a5f6-08991249',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b802804485b',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b802804485b')) {function content_57b802804485b($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>暂时关闭充值：</label>  
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="is_close" value="1" <?php if ($_smarty_tpl->tpl_vars['system_config']->value['IS_CLOSE']==1){?>checked="checked"<?php }?> />是</label>  
            <label><input type="radio" name="is_close" value="0" <?php if ($_smarty_tpl->tpl_vars['system_config']->value['IS_CLOSE']==0){?>checked="checked"<?php }?>/>否</label>   
        </div>  
    </div>  
</div>
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="Wdate" name="close_start_time" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['system_config']->value['CLOSE_START_TIME'],'%H:%M:%S');?>
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="Wdate" name="close_end_time" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['system_config']->value['CLOSE_END_TIME'],'%H:%M:%S');?>
"  onclick="WdatePicker({ dateFmt:'H:mm:ss'})">
        <span class="fi-help-text"></span>  
    </div>  
</div>
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <textarea name="close_recharge_alert" ><?php echo $_smarty_tpl->tpl_vars['system_config']->value['CLOSE_RECHARGE_ALERT'];?>
</textarea>  
