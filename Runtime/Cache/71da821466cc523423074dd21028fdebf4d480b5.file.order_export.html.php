<?php /* Smarty version Smarty-3.1.6, created on 2016-08-22 15:37:37
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpOrder/order_export.html" */ ?>
<?php /*%%SmartyHeaderCode:184688639957baabc1b1ab63-48154477%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '71da821466cc523423074dd21028fdebf4d480b5' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpOrder/order_export.html',
      1 => 1471252524,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '184688639957baabc1b1ab63-48154477',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57baabc1dbb41',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57baabc1dbb41')) {function content_57baabc1dbb41($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<link rel="stylesheet" href="/Public/Css/acp/AcpOrder/get_history_order.css" type="text/css" />
...
<div class="t-his-top">
    <div class="t-his-top-li">
        <div class="formitems inline">  
            <label class="fi-name" style="width:70px;">订单状态：</label>  
            <div class="form-controls" style="margin-left:70px;">  
                <select class="mini" name="order_status" id="order_status">  
                    <option value="">请选择</option>   
                    <option value="<?php echo OrderModel::CONFIRMED;?>
">已完成</option>
                    <option value="<?php echo OrderModel::CANCELED;?>
">已关闭</option> 
                    <option value="<?php echo OrderModel::REFUND_DELIVER_CONFIRMD;?>
">已退货</option> 
                </select>  
    ...
    <div class="t-his-top-li">
        <div class="formitems inline">  
            <label class="fi-name" style="width:75px; color:#666;">选择时间段：</label>  
            <div class="form-controls" style="margin-left:80px;">  
                <input type="text" autocomplete="off" name="start_time" id="start_time" class="Wdate" onclick="WdatePicker({ dateFmt:'yyyy-MM-dd H:mm:ss'})">  
                <span class="fi-text">-</span>  
                <input type="text" autocomplete="off" name="end_time" id="end_time" class="Wdate" onclick="WdatePicker({ dateFmt:'yyyy-MM-dd H:mm:ss'})">  
            </div>
        </div>    
    </div>
	<div class="t-his-top-li">
		<input type="hidden" name="act" value="export">
		<button type="submit" class="btn">导出订单</button>
	</div>
</div>
</form>

<div class="t-his-bottom">
	<p>注：</p>
    <p>1 . 每个 EXCEL文件 导出的最大订单条数和平均每个订单中所包含的商品件数成正比！</p>
    <p>2 . 如果您在进行订单导出时遇到未知的问题，请试图改小每个 EXCEL文件 导出的订单条数 ！</p>
    <p>3 . 在进行订单导出时，可能需要很长一段时间，请不要刷新页面   ！</p>
</div>
