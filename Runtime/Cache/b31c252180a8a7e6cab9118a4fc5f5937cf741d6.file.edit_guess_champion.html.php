<?php /* Smarty version Smarty-3.1.6, created on 2016-09-19 16:33:07
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessChampion/edit_guess_champion.html" */ ?>
<?php /*%%SmartyHeaderCode:197677319857b3fa8fceb473-71276665%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b31c252180a8a7e6cab9118a4fc5f5937cf741d6' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessChampion/edit_guess_champion.html',
      1 => 1474273946,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '197677319857b3fa8fceb473-71276665',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b3fa8fe5451',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b3fa8fe5451')) {function content_57b3fa8fe5451($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="xlarge" name="title" id="title" value="<?php echo $_smarty_tpl->tpl_vars['guess_champion_info']->value['title'];?>
">  
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="Wdate" name="start_time" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['guess_champion_info']->value['start_time'],'%Y-%m-%d %H:%M:%S');?>
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="Wdate" name="end_time" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['guess_champion_info']->value['end_time'],'%Y-%m-%d %H:%M:%S');?>
"  onclick="WdatePicker({ dateFmt:'yyyy-MM-dd H:mm:ss'})">
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
" <?php if ($_smarty_tpl->tpl_vars['guess_champion_info']->value['province_id']==$_smarty_tpl->tpl_vars['province']->value['province_id']){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['province']->value['province_name'];?>
</option>
            <?php } ?>
        </select>
...
" <?php if ($_smarty_tpl->tpl_vars['guess_champion_info']->value['city_id']==$_smarty_tpl->tpl_vars['city']->value['city_id']){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['city']->value['city_name'];?>
</option>
            <?php } ?>
        </select>
...
" <?php if ($_smarty_tpl->tpl_vars['guess_champion_info']->value['area_id']==$_smarty_tpl->tpl_vars['area']->value['area_id']){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['area']->value['area_name'];?>
</option>
            <?php } ?>
        </select> </br>
        <input type="text" placeholder="请填写具体地址" name="address" style="width:400px" value="<?php echo $_smarty_tpl->tpl_vars['guess_champion_info']->value['address'];?>
">
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
    ...
    <div class="form-controls">
        <div  id="img_path">
            <ul class="fi-imgslist" style="float:left;">
                <li class="preview fi-imgslist-item pic<?php if (!$_smarty_tpl->tpl_vars['guess_champion_info']->value['img_path']||!file_exists($_smarty_tpl->tpl_vars['img_path_path']->value)){?> hide<?php }?>" id="preview" style="">
                    <div>
                        <img id="J_Preview" style="height: 65px;" src="<?php echo $_smarty_tpl->tpl_vars['guess_champion_info']->value['img_path'];?>
"/>
                    </div>
                    <input type="hidden" name="img_path" id="J_ImgUrl" data-id="<?php if ($_smarty_tpl->tpl_vars['guess_champion_info']->value['img_path']){?><?php }?>" value="<?php echo $_smarty_tpl->tpl_vars['guess_champion_info']->value['img_path'];?>
" />
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="mini" name="serial" id="serial" value="<?php echo $_smarty_tpl->tpl_vars['guess_champion_info']->value['serial'];?>
">  
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="isuse" value="1" <?php if ($_smarty_tpl->tpl_vars['guess_champion_info']->value['isuse']==1){?>checked="checked"<?php }?> />是</label>  
            <label><input type="radio" name="isuse" value="0" <?php if ($_smarty_tpl->tpl_vars['guess_champion_info']->value['isuse']==0){?>checked="checked"<?php }?>/>否</label>   
        </div>  
    </div>  
</div> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        ...
        <input type="hidden" name="guess_id" value="<?php echo $_smarty_tpl->tpl_vars['guess_id']->value;?>
" />
