<?php /* Smarty version Smarty-3.1.6, created on 2016-09-26 11:16:06
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpTeam/edit_team.html" */ ?>
<?php /*%%SmartyHeaderCode:54422628857b26c499f0296-73251084%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8e12543e72764dbcea553097055ba60df89fa265' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpTeam/edit_team.html',
      1 => 1474859765,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '54422628857b26c499f0296-73251084',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b26c49b9c3d',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b26c49b9c3d')) {function content_57b26c49b9c3d($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
?>
            <option value="<?php echo $_smarty_tpl->tpl_vars['item']->value['guess_type_id'];?>
" <?php if ($_smarty_tpl->tpl_vars['item']->value['guess_type_id']==$_smarty_tpl->tpl_vars['team_info']->value['guess_type_id']){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['item']->value['guess_type_name'];?>
</option>
            <?php } ?>
        </select>
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="xlarge" name="team_name" id="team_name" value="<?php echo $_smarty_tpl->tpl_vars['team_info']->value['team_name'];?>
">  
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
    ...
    <div class="form-controls">
        <div  id="team_logo">
            <ul class="fi-imgslist" style="float:left;">
                <li class="preview fi-imgslist-item pic<?php if (!$_smarty_tpl->tpl_vars['team_info']->value['team_logo']||!file_exists($_smarty_tpl->tpl_vars['team_logo_path']->value)){?> hide<?php }?>" id="preview" style="">
                    <div>
                        <img id="J_Preview" style="height: 65px;" src="<?php echo $_smarty_tpl->tpl_vars['team_info']->value['team_logo'];?>
"/>
                    </div>
                    <input type="hidden" name="team_logo" id="J_ImgUrl" data-id="<?php if ($_smarty_tpl->tpl_vars['team_info']->value['team_logo']){?><?php }?>" value="<?php echo $_smarty_tpl->tpl_vars['team_info']->value['team_logo'];?>
" />
                ...
                <li class="fi-imgslist-item<?php if ($_smarty_tpl->tpl_vars['team_logo_path']->value&&file_exists($_smarty_tpl->tpl_vars['team_logo_path']->value)){?> hide<?php }?>" id="add_li">
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <textarea placeholder="" class="xlarge" name="team_desc" id="team_desc" ><?php echo $_smarty_tpl->tpl_vars['team_info']->value['team_desc'];?>
</textarea>
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="mini" name="serial" id="serial" value="<?php echo $_smarty_tpl->tpl_vars['team_info']->value['serial'];?>
">  
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="isuse" value="1" <?php if ($_smarty_tpl->tpl_vars['team_info']->value['isuse']==1){?>checked="checked"<?php }?> />是</label>  
            <label><input type="radio" name="isuse" value="0" <?php if ($_smarty_tpl->tpl_vars['team_info']->value['isuse']==0){?>checked="checked"<?php }?>/>否</label>   
        </div>  
    </div>  
</div> 
