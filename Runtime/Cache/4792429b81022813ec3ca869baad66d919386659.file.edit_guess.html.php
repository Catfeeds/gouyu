<?php /* Smarty version Smarty-3.1.6, created on 2016-10-10 09:43:51
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuess/edit_guess.html" */ ?>
<?php /*%%SmartyHeaderCode:76012142157b288efe71263-27055371%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4792429b81022813ec3ca869baad66d919386659' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuess/edit_guess.html',
      1 => 1475042111,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '76012142157b288efe71263-27055371',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b288f00edc6',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b288f00edc6')) {function content_57b288f00edc6($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
" <?php if ($_smarty_tpl->tpl_vars['item']->value['guess_type_id']==$_smarty_tpl->tpl_vars['guess_info']->value['guess_type_id']){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['item']->value['guess_type_name'];?>
</option>
            <?php } ?>
        </select>
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="xlarge" name="guess_name" id="guess_name" value="<?php echo $_smarty_tpl->tpl_vars['guess_info']->value['guess_name'];?>
">  
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
" <?php if ($_smarty_tpl->tpl_vars['item']->value['team_id']==$_smarty_tpl->tpl_vars['guess_info']->value['host_team']){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['item']->value['team_name'];?>
</option>
            <?php } ?>
        </select>
...
?>
            <option value="<?php echo $_smarty_tpl->tpl_vars['item']->value['team_id'];?>
" <?php if ($_smarty_tpl->tpl_vars['item']->value['team_id']==$_smarty_tpl->tpl_vars['guess_info']->value['guest_team']){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['item']->value['team_name'];?>
</option>
            <?php } ?>
        </select>
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="number" placeholder="" class="mini" name="bo"  value="<?php echo $_smarty_tpl->tpl_vars['guess_info']->value['bo'];?>
">  
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="Wdate" name="start_time" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['guess_info']->value['start_time'],'%Y-%m-%d %H:%M:%S');?>
