<?php /* Smarty version Smarty-3.1.6, created on 2016-09-13 11:58:38
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpDrawPrize/draw_prize_detail.html" */ ?>
<?php /*%%SmartyHeaderCode:200553584257d7796e617391-74437246%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1cc3c98fc310b83ad26ff20027dc76ed80ecbcb6' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpDrawPrize/draw_prize_detail.html',
      1 => 1471508049,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '200553584257d7796e617391-74437246',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57d7796e907cc',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d7796e907cc')) {function content_57d7796e907cc($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
<div class="t-detail-top">
	<div class="top-tit">
		用户昵称：<?php echo $_smarty_tpl->tpl_vars['user_info']->value['nickname'];?>

	</div>
</div>
<div class="t-detail-goods">

	<div class="t-detail-goods-tit mag">夺宝信息：</div>
    <div class="t-detail-goods-con t-buser">
    	<table class="wxtables tables-form">  
            ...
            <tbody>  
                <tr>  
                    <td class="tables-form-title">奖品图片：</td>  
					<td><img src="<?php echo $_smarty_tpl->tpl_vars['treasure_info']->value['img_path'];?>
" style="width:50px;"></td> 
                </tr> 
                <tr>
                    <td class="tables-form-title">奖品名称：</td>  
					<td><?php if ($_smarty_tpl->tpl_vars['treasure_info']->value['prize_name']){?><?php echo $_smarty_tpl->tpl_vars['treasure_info']->value['prize_name'];?>
<?php }else{ ?>--<?php }?></td>
                </tr>
                <tr>  
					<td class="tables-form-title">期数：</td>  
					<td><?php echo $_smarty_tpl->tpl_vars['treasure_info']->value['periods'];?>
</td>
                </tr>  
                <tr>  
                    <td class="tables-form-title">开奖时间：</td>  
					<td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['treasure_info']->value['open_time'],"%Y-%m-%d %H:%M:%S");?>
</td> 
                </tr> 
                <tr>  
                    <td class="tables-form-title">时时彩中奖号码：</td>  
                    <td><?php echo $_smarty_tpl->tpl_vars['treasure_info']->value['draw_lottery'];?>
</td> 
                </tr>
                <tr>  
                    <td class="tables-form-title">夺宝中奖号码：</td>  
                    <td><?php echo $_smarty_tpl->tpl_vars['treasure_info']->value['lottery'];?>
</td> 
                </tr>
                <tr>  
                    <td class="tables-form-title">游戏名称：</td>  
                    <td><?php echo $_smarty_tpl->tpl_vars['treasure_user_info']->value['game_name'];?>
</td> 
                </tr>
                <tr>  
                    <td class="tables-form-title">游戏账号：</td>  
                    <td><?php echo $_smarty_tpl->tpl_vars['treasure_user_info']->value['game_account'];?>
</td> 
                </tr>
            </tbody>  
        </table>   
