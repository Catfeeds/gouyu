<?php /* Smarty version Smarty-3.1.6, created on 2016-08-17 09:35:05
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessQuestion/edit_guess_question.html" */ ?>
<?php /*%%SmartyHeaderCode:44147884157b3beee8c06c9-13344720%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f7ce77c9476eea65de4039939f07bfdc9da9d6d1' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessQuestion/edit_guess_question.html',
      1 => 1471397704,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '44147884157b3beee8c06c9-13344720',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b3beeea38d0',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b3beeea38d0')) {function content_57b3beeea38d0($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="xlarge" name="desc" id="desc" value="<?php echo $_smarty_tpl->tpl_vars['guess_question_info']->value['desc'];?>
">  
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="mini" name="serial" id="serial" value="<?php echo $_smarty_tpl->tpl_vars['guess_question_info']->value['serial'];?>
">  
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="isuse" value="1"  <?php if ($_smarty_tpl->tpl_vars['guess_question_info']->value['isuse']==1){?>checked<?php }?>/>是</label>  
            <label><input type="radio" name="isuse" value="0" <?php if ($_smarty_tpl->tpl_vars['guess_question_info']->value['isuse']==0){?>checked<?php }?>/>否</label>   
        </div>  
    </div>  
</div> 
