<?php /* Smarty version Smarty-3.1.6, created on 2016-10-10 16:25:02
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/FrontTreasure/draw_prize_record.html" */ ?>
<?php /*%%SmartyHeaderCode:130705039257c396669d9ad8-54570252%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8497181810d601165e197776f484521336297d90' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/FrontTreasure/draw_prize_record.html',
      1 => 1476087140,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '130705039257c396669d9ad8-54570252',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57c39666a8651',
  'variables' => 
  array (
    'version' => 0,
    'user_id' => 0,
...
<?php if ($_valid && !is_callable('content_57c39666a8651')) {function content_57c39666a8651($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.date_format.php';
?><!doctype html>
...
?>
                    <div class="lottery_box_cont clearfix" onclick="redirect('<?php echo $_smarty_tpl->tpl_vars['award_record_by_prize_link']->value;?>
<?php echo $_smarty_tpl->tpl_vars['item']->value['prize_id'];?>
')">
...
" class="lazy" />
							...
							<span>获得</span>
                            <p><?php echo $_smarty_tpl->tpl_vars['item']->value['prize_name'];?>
</p>
						</div>
						...
						<div class="lottery_right_box fr">
							<div class="lottery_right_top">
                                开奖时间<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['item']->value['addtime'],"%Y-%m-%d %H:%M:%S");?>

							</div>
							<div class="lottery_right_bottom clearfix">
                                <img data-original="<?php echo $_smarty_tpl->tpl_vars['item']->value['prize_logo'];?>
" class="fl lazy" />
								<ul class="fl">
                                    <li>期数:第<p><?php echo (($tmp = @$_smarty_tpl->tpl_vars['item']->value['periods'])===null||$tmp==='' ? 1 : $tmp);?>
</p>期</li>
                                    <li>夺宝号码:<p><?php echo (($tmp = @$_smarty_tpl->tpl_vars['item']->value['lottery'])===null||$tmp==='' ? "未知" : $tmp);?>
</p></li>
                                    <li>本期参与:<p><?php echo (($tmp = @$_smarty_tpl->tpl_vars['item']->value['people_use_times'])===null||$tmp==='' ? 1 : $tmp);?>
</p>人次</li>
                                    <li>夺宝成功率:<p><?php echo (($tmp = @$_smarty_tpl->tpl_vars['item']->value['award_rate'])===null||$tmp==='' ? 20 : $tmp);?>
%</p></li>
...
"></script>
	...
	<![endif]-->
		...
		<script type="text/javascript" src="__JS__/front/front_js/item_list.js" ></script>
