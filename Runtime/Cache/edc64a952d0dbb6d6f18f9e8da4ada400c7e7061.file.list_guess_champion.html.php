<?php /* Smarty version Smarty-3.1.6, created on 2016-09-23 10:24:04
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessChampion/list_guess_champion.html" */ ?>
<?php /*%%SmartyHeaderCode:3752197257b3d74baad3e3-26891952%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'edc64a952d0dbb6d6f18f9e8da4ada400c7e7061' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessChampion/list_guess_champion.html',
      1 => 1474597440,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3752197257b3d74baad3e3-26891952',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b3d74bd8381',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b3d74bd8381')) {function content_57b3d74bd8381($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
<div class="tablesWrap">  
    <div class="tables-searchbox">
       <!--- <form method="post" action="">
            ...
            <input type="text" name="guess_champion_name" value="<?php echo $_smarty_tpl->tpl_vars['guess_champion_name']->value;?>
">
...
<table class="wxtables">  
 ...
 $_from = $_smarty_tpl->tpl_vars['guess_champion_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
    <tbody class="combo-tbody">  
        <tr>
			<td><input type="checkbox" class="checkbox" name="a[]" value="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['guess_champion_id'];?>
"></td>
            <td><img src="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['img_path'];?>
" onerror="no_pic()" style="height:50px;width:50px;"/></td>  
			<td><?php echo $_smarty_tpl->tpl_vars['question_class']->value['title'];?>
</td>  
            ...
            <td>  
				<a href="/AcpGuessChampion/edit_guess_champion/guess_champion_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['guess_champion_id'];?>
.html" class="btn" title="修改">修改</a>  
                <a href="javascript:;" class="btn" title="删除" onclick="delete_question_class(<?php echo $_smarty_tpl->tpl_vars['question_class']->value['guess_champion_id'];?>
)">删除</a>  
				<a href="/AcpGuessChampionTeam/list_guess_champion_team/guess_champion_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['guess_champion_id'];?>
.html" class="btn" title="冠军队伍">冠军队伍</a>  
                <a href="/AcpGuessChampion/look_odds_detail/guess_champion_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['guess_champion_id'];?>
.html" class="btn" target="_blank" title="查看投注分布">投注分布</a>  
                ...
                <a href="javascript:;" class="btn" title="设置开关盘" onclick="set_start_guess_field(<?php echo $_smarty_tpl->tpl_vars['question_class']->value['guess_champion_id'];?>
, 2)">关盘</a>  
...
, 2)">关盘</a>  
                <?php }?>
                <a href="javascript:;" class="btn" title="全额退款" onclick="refund_question_class(<?php echo $_smarty_tpl->tpl_vars['question_class']->value['guess_champion_id'];?>
)">全额退款</a>  
                <a href="javascript:;" class="btn" title="设置结束" onclick="set_over(<?php echo $_smarty_tpl->tpl_vars['question_class']->value['guess_champion_id'];?>
)">设置结束</a>  
                <?php }?>
            </td>  
        </tr>
