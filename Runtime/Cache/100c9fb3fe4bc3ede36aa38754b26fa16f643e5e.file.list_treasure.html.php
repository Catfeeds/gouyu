<?php /* Smarty version Smarty-3.1.6, created on 2017-03-03 15:27:51
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpTreasure/list_treasure.html" */ ?>
<?php /*%%SmartyHeaderCode:230577257b415072a06a7-37462215%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '100c9fb3fe4bc3ede36aa38754b26fa16f643e5e' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpTreasure/list_treasure.html',
      1 => 1488526070,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '230577257b415072a06a7-37462215',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b415074c6e9',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b415074c6e9')) {function content_57b415074c6e9($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
<!-- end tables-searchbox -->  
    <div class="tables-searchbox">
        <form method="post" action="">
            ...
            <input type="text" name="prize_name" value="<?php echo $_smarty_tpl->tpl_vars['prize_name']->value;?>
">


            <select name="is_open">
                <option value="0" selected="">-是否开奖-</option>
                <option value="1" <?php if ($_smarty_tpl->tpl_vars['is_open']->value==1){?>selected<?php }?>>已开奖</option>
                <option value="2" <?php if ($_smarty_tpl->tpl_vars['is_open']->value==2){?>selected<?php }?>>未开奖</option>
                <option value="3" <?php if ($_smarty_tpl->tpl_vars['is_open']->value==3){?>selected<?php }?>>已退款</option>
            </select>
            <select name="is_fuli">
                <option value="0" selected="">-是否福利-</option>
                <option value="1" <?php if ($_smarty_tpl->tpl_vars['is_fuli']->value==1){?>selected<?php }?>>福利专区</option>
                <option value="2" <?php if ($_smarty_tpl->tpl_vars['is_fuli']->value==2){?>selected<?php }?>>非福利专区</option>
            </select>

                <span class="tbs-txt">开始时间：</span>
                <input type="text" autocomplete="off" class="Wdate" name="start_date" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['start_date']->value,'%Y-%m-%d %H:%M:%S');?>
"  onclick="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss'})">
                <span class="tbs-txt">至</span>
                <input type="text" autocomplete="off" class="Wdate" name="end_date" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['end_date']->value,'%Y-%m-%d %H:%M:%S');?>
"  onclick="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss'})">
...
?>
    <tbody class="combo-tbody">  
        <tr>
			<td><input type="checkbox" class="checkbox" name="a[]" value="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['treasure_id'];?>
"></td>
...
" style="width:50px;height:50px"></td>  
			...
			<td><?php echo $_smarty_tpl->tpl_vars['question_class']->value['total_person_times'];?>
</td>  
			<td><?php echo $_smarty_tpl->tpl_vars['question_class']->value['periods'];?>
</td>  
			<td><?php echo $_smarty_tpl->tpl_vars['question_class']->value['each_person_times'];?>
</td>  
            <td><?php if ($_smarty_tpl->tpl_vars['question_class']->value['draw_lottery']==0){?>未设置<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['question_class']->value['draw_lottery'];?>
<?php }?></td>  
            <td><?php if ($_smarty_tpl->tpl_vars['question_class']->value['lottery']==0){?>未设置<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['question_class']->value['lottery'];?>
<?php }?></td>  
			...
			<td><?php echo $_smarty_tpl->tpl_vars['question_class']->value['people_num'];?>
</td>  
			<td><?php if ($_smarty_tpl->tpl_vars['question_class']->value['is_fuli']==1){?>是<?php }else{ ?>否<?php }?></td>  
            <td>  
                <a href="javascript:;" class="btn" title="删除" onclick="delete_question_class(<?php echo $_smarty_tpl->tpl_vars['question_class']->value['treasure_id'];?>
)">删除</a>  
                <a href="javascript:;" class="btn j_form" title="设置结果" data-id="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['treasure_id'];?>
" >设置结果</a>
				<a href="/AcpTreasureUser/list_treasure_user/treasure_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['treasure_id'];?>
.html" class="btn" title="夺宝用户">夺宝用户列表</a>  
                <?php if ($_smarty_tpl->tpl_vars['question_class']->value['is_open']){?>
                <?php if ($_smarty_tpl->tpl_vars['question_class']->value['lottery']){?>
				<a href="/AcpDrawPrize/list_draw_prize/treasure_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['treasure_id'];?>
.html" class="btn" title="">查看中奖结果</a>  
                <?php }?>
                <?php }else{ ?>
				<a href="/AcpTreasure/edit_treasure/treasure_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['treasure_id'];?>
