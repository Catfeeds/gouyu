<?php /* Smarty version Smarty-3.1.6, created on 2016-10-09 10:01:56
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpConfig/set_recharge_back.html" */ ?>
<?php /*%%SmartyHeaderCode:23430603157ecc7f5691e87-78374961%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aaf8073837224d1b3fb796a9d76a5b7ce4b0bb65' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpConfig/set_recharge_back.html',
      1 => 1475978345,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '23430603157ecc7f5691e87-78374961',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57ecc7f589425',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57ecc7f589425')) {function content_57ecc7f589425($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>充值返利：</label>  
    <div class="form-controls">  
        <div class="radio-group recharge_back">  
            <label><input type="radio" name="is_recharge_back_close"  value="1" <?php if ($_smarty_tpl->tpl_vars['system_config']->value['IS_RECHARGE_BACK_CLOSE']==1){?>checked="checked"<?php }?> />开启</label>  
            <label><input type="radio" name="is_recharge_back_close"  value="0" <?php if ($_smarty_tpl->tpl_vars['system_config']->value['IS_RECHARGE_BACK_CLOSE']==0){?>checked="checked"<?php }?>/>关闭</label>   
        </div>  
    </div>  
</div>
<!--<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="Wdate" name="close_exchange_start_time" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['system_config']->value['CLOSE_EXCHANGE_START_TIME'],'%H:%M:%S');?>
"  onclick="WdatePicker({ dateFmt:'H:mm:ss'})">
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="Wdate" name="close_exchange_end_time" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['system_config']->value['CLOSE_EXCHANGE_END_TIME'],'%H:%M:%S');?>
"  onclick="WdatePicker({ dateFmt:'H:mm:ss'})">
        <span class="fi-help-text"></span>  
    </div>  
</div>
...
<div class="formitems inline recharge_back_pro" <?php if ($_smarty_tpl->tpl_vars['system_config']->value['IS_RECHARGE_BACK_CLOSE']==0){?>style="display:none"<?php }?>>  
    <label class="fi-name"><span class="colorRed">*</span>返利比例：</label>   
    <div class="form-controls">  
        <input name="recharge_back_pro" value="<?php echo $_smarty_tpl->tpl_vars['system_config']->value['RECHARGE_BACK_PRO'];?>
" class="mini"/>%  
        <span class="fi-help-text"></span>  
    </div>    
</div>
<div class="formitems inline close_recharge_back_alert" <?php if ($_smarty_tpl->tpl_vars['system_config']->value['IS_RECHARGE_BACK_CLOSE']==1){?>style="display:none"<?php }?>>  
    <label class="fi-name"><span class="colorRed">*</span>关闭后提示信息：</label>   
    <div class="form-controls">  
        <textarea name="close_recharge_back_alert" ><?php echo $_smarty_tpl->tpl_vars['system_config']->value['CLOSE_RECHARGE_BACK_ALERT'];?>
</textarea>  
        <span class="fi-help-text">一般在50字以内</span>  
    </div>    
</div>
...
<script>
$(function(){
    $(".recharge_back label").on("click", function(){
        var yes = $(this).children('input').val();
        console.log(yes);
        if (yes == 1) {
            $(".recharge_back_pro").show();
            $(".close_recharge_back_alert").hide();
        } else {
            $(".recharge_back_pro").hide();
            $(".close_recharge_back_alert").show();
        }
    });
});
</script>
