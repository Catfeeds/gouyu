<?php /* Smarty version Smarty-3.1.6, created on 2016-09-08 17:30:37
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessChampionTeam/edit_guess_champion_team.html" */ ?>
<?php /*%%SmartyHeaderCode:43429380057b406d68bc2c3-74825546%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f04de458d10952a2cd1c4fbf4c4467e12c36a0f9' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessChampionTeam/edit_guess_champion_team.html',
      1 => 1473326949,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '43429380057b406d68bc2c3-74825546',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b406d6a37af',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b406d6a37af')) {function content_57b406d6a37af($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
" <?php if ($_smarty_tpl->tpl_vars['item']->value['team_id']==$_smarty_tpl->tpl_vars['guess_champion_team_info']->value['team_id']){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['item']->value['team_name'];?>
</option>
            <?php } ?>
        </select>
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" autocomplete="off" class="mini" name="odds" value="<?php echo $_smarty_tpl->tpl_vars['guess_champion_team_info']->value['odds'];?>
" >
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="mini" name="serial" id="serial" value="<?php echo $_smarty_tpl->tpl_vars['guess_champion_team_info']->value['serial'];?>
">  
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="isuse" value="1"  <?php if ($_smarty_tpl->tpl_vars['guess_champion_team_info']->value['isuse']==1){?>checked<?php }?>/>是</label>  
            <label><input type="radio" name="isuse" value="0" <?php if ($_smarty_tpl->tpl_vars['guess_champion_team_info']->value['isuse']==0){?>checked<?php }?>/>否</label>   
        </div>  
    </div>  
</div> 
