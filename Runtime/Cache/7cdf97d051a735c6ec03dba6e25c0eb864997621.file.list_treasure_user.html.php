<?php /* Smarty version Smarty-3.1.6, created on 2016-08-18 15:21:29
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpTreasureUser/list_treasure_user.html" */ ?>
<?php /*%%SmartyHeaderCode:95016560157b5601b6c2dc2-17885401%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7cdf97d051a735c6ec03dba6e25c0eb864997621' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpTreasureUser/list_treasure_user.html',
      1 => 1471504888,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '95016560157b5601b6c2dc2-17885401',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b5601b96aae',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b5601b96aae')) {function content_57b5601b96aae($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
?>
    <tbody class="combo-tbody">  
        <tr>
			<td><input type="checkbox" class="checkbox" name="a[]" value="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['treasure_user_id'];?>
"></td>
            ...
            <!--<td>  
				<a href="/AcpTreasureUser/edit_treasure_user/treasure_user_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['treasure_user_id'];?>
.html" class="btn" title="修改">修改</a>  
                <a href="javascript:;" class="btn" title="删除" onclick="delete_question_class(<?php echo $_smarty_tpl->tpl_vars['question_class']->value['treasure_user_id'];?>
)">删除</a>  
                </td>-->  
        </tr>
    </tbody>
...
function delete_question_class(question_class_id)
{
	...
	{  
		 ...
		 {  
			 if(r)
			 {
				 $.post('/AcpTreasureUser/del_treasure_user', {"treasure_user_id":question_class_id}, function(data, textStatus) 
				 {
					if (data == 'success')
					{
						alert('恭喜您，删除成功！');
	...
	{  
		 ...
		 {  
			 if(r)
			 {
				 ...
				 $.post('/AcpTreasureUser/batch_del_treasure_user', {"question_class_ids":question_class_ids}, function(data, textStatus) 
				 {
					if (data == 'success')
					{
						alert('恭喜您，删除成功！');
