<?php /* Smarty version Smarty-3.1.6, created on 2016-08-19 16:46:10
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpClass/edit_level_two.html" */ ?>
<?php /*%%SmartyHeaderCode:146450066057b6c7400c4d54-67885670%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bd35b64c5f64d9362cd51880adffc7e17bc9cf4e' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpClass/edit_level_two.html',
      1 => 1471596369,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '146450066057b6c7400c4d54-67885670',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b6c7402460d',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b6c7402460d')) {function content_57b6c7402460d($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="formitems inline">  
    ...
    <option value="<?php echo $_smarty_tpl->tpl_vars['class_info']->value['class_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['class_info']->value['class_name'];?>
</option>
    <?php  $_smarty_tpl->tpl_vars['row'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['row']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['level_one_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['row']->key => $_smarty_tpl->tpl_vars['row']->value){
$_smarty_tpl->tpl_vars['row']->_loop = true;
?>
    <?php if ($_smarty_tpl->tpl_vars['row']->value['class_id']!=$_smarty_tpl->tpl_vars['class_info']->value['class_id']){?>
    <option value="<?php echo $_smarty_tpl->tpl_vars['row']->value['class_id'];?>
...
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span>二级分类名称：</label>  
    <div class="form-controls">  
		<input type="text" placeholder="" class="xlarge" name="sort_name" id="sort_name" value="<?php echo $_smarty_tpl->tpl_vars['class_info']->value['sort_name'];?>
">  
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    <label class="fi-name">是否在快速订单显示：</label>  
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="is_first_order" value="1" <?php if ($_smarty_tpl->tpl_vars['class_info']->value['is_first_order']==1){?>checked="checked"<?php }?> />是</label>  
            <label><input type="radio" name="is_first_order" value="0" <?php if ($_smarty_tpl->tpl_vars['class_info']->value['is_first_order']==0){?>checked="checked"<?php }?> />否</label>   
        </div>  
    </div>  
</div> 
-->
