<?php /* Smarty version Smarty-3.1.6, created on 2016-08-28 13:57:26
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpRollAward/roll_award_detail.html" */ ?>
<?php /*%%SmartyHeaderCode:106578802357c27d463bc4a5-31450883%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd1d6cdfec8e29b465a7a16d388cf00a53ad7c9b9' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpRollAward/roll_award_detail.html',
      1 => 1471594063,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '106578802357c27d463bc4a5-31450883',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57c27d466493e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c27d466493e')) {function content_57c27d466493e($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
<div class="t-detail-goods">
    ...
    <div class="t-detail-goods-con t-buser">
    	<table class="wxtables tables-form">  
            ...
            <tbody>  
                <tr>
                    <td class="tables-form-title">roll名称：</td>  
					<td><?php if ($_smarty_tpl->tpl_vars['roll_info']->value['roll_name']){?><?php echo $_smarty_tpl->tpl_vars['roll_info']->value['roll_name'];?>
<?php }else{ ?>--<?php }?></td>
                </tr>
                <tr>  
                    <td class="tables-form-title">奖品图片：</td>  
					<td><img src="<?php echo $_smarty_tpl->tpl_vars['roll_info']->value['img_path'];?>
" style="width:50px;"></td> 
                </tr> 
                <tr>  
                    <td class="tables-form-title">开奖时间：</td>  
					<td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['roll_info']->value['open_time'],"%Y-%m-%d %H:%M:%S");?>
</td> 
                </tr> 
                <tr>  
                    <td class="tables-form-title">夺宝中奖号码：</td>  
                    <td><?php echo $_smarty_tpl->tpl_vars['roll_info']->value['id'];?>
</td> 
                </tr>
                <tr>  
                    <td class="tables-form-title">游戏名称：</td>  
                    <td><?php echo $_smarty_tpl->tpl_vars['roll_user_info']->value['game_name'];?>
</td> 
                </tr>
                <tr>  
                    <td class="tables-form-title">游戏账号：</td>  
                    <td><?php echo $_smarty_tpl->tpl_vars['roll_user_info']->value['game_account'];?>
</td> 
                </tr>
            </tbody>  
        </table>   
