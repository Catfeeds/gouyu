<?php /* Smarty version Smarty-3.1.6, created on 2016-08-17 16:47:47
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpGame/list_game.html" */ ?>
<?php /*%%SmartyHeaderCode:62222868457b422ff8b4b18-06126002%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '65af3e8b663be1b60be81d25529c906058b4e825' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpGame/list_game.html',
      1 => 1471423666,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '62222868457b422ff8b4b18-06126002',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b422ffb419c',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b422ffb419c')) {function content_57b422ffb419c($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
?>
    <tbody class="combo-tbody">  
        <tr>
			<td><input type="checkbox" class="checkbox" name="a[]" value="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['game_id'];?>
"></td>
            ...
            <td>  
				<a href="/AcpGame/edit_game/game_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['game_id'];?>
.html" class="btn" title="修改">修改</a>  
                <a href="javascript:;" class="btn" title="删除" onclick="delete_question_class(<?php echo $_smarty_tpl->tpl_vars['question_class']->value['game_id'];?>
)">删除</a>  
            </td>  
        </tr>
    </tbody>
