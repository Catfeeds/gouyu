<?php /* Smarty version Smarty-3.1.6, created on 2016-08-19 17:49:50
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpOrder/get_refund_change_order_list.html" */ ?>
<?php /*%%SmartyHeaderCode:132822075357b6d63e8c2642-58080897%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c748d356beaed656843ade2258efbeaf48bc5e30' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpOrder/get_refund_change_order_list.html',
      1 => 1471252524,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '132822075357b6d63e8c2642-58080897',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57b6d63eb098d',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57b6d63eb098d')) {function content_57b6d63eb098d($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("./Public_forms.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '132822075357b6d63e8c2642-58080897');
content_57b6d63e9e061($_smarty_tpl);
...
<table class="wxtables">  
    ...
    <tbody>  
        <?php  $_smarty_tpl->tpl_vars['refund_change_info'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['refund_change_info']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['order_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['refund_change_info']->key => $_smarty_tpl->tpl_vars['refund_change_info']->value){
$_smarty_tpl->tpl_vars['refund_change_info']->_loop = true;
?>
			<tr>
				<td><input type="checkbox" class="checkbox" name="a[]" value="<?php echo $_smarty_tpl->tpl_vars['refund_change_info']->value['item_refund_change_id'];?>
"></td>
				<td><?php echo $_smarty_tpl->tpl_vars['refund_change_info']->value['order_sn'];?>
</td>
				<td>  
					<span>￥</span>  
					<span><?php echo $_smarty_tpl->tpl_vars['refund_change_info']->value['total_amount']+$_smarty_tpl->tpl_vars['refund_change_info']->value['express_fee'];?>
</span>  
				</td>  
				<td>  
					<span>￥</span>  
					<span><?php echo $_smarty_tpl->tpl_vars['refund_change_info']->value['pay_amount'];?>
</span>  
				</td>  
				<td>
					<span>￥</span>  
					<span><?php echo $_smarty_tpl->tpl_vars['refund_change_info']->value['refund_money'];?>
</span>
				</td>  
				<td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['refund_change_info']->value['addtime'],"%Y-%m-%d %H:%M:%S");?>
</td>  
				<td><?php echo $_smarty_tpl->tpl_vars['refund_change_info']->value['reason'];?>
</td>  
				<td>
					<?php if ($_smarty_tpl->tpl_vars['refund_change_info']->value['state']==0){?>
						待处理
					<?php }elseif($_smarty_tpl->tpl_vars['refund_change_info']->value['state']==1){?>
						已受理
					<?php }elseif($_smarty_tpl->tpl_vars['refund_change_info']->value['state']==1){?>
						已拒绝
					<?php }?>
				...
				<td>  
					<a href="/AcpOrder/order_refund_change_apply_detail/item_refund_change_id/<?php echo $_smarty_tpl->tpl_vars['refund_change_info']->value['item_refund_change_id'];?>
/order_id/<?php echo $_smarty_tpl->tpl_vars['refund_change_info']->value['order_id'];?>
/redirect/<?php echo $_smarty_tpl->tpl_vars['redirect']->value;?>
" class="btn" title="查看">查看</a>   
					<?php if ($_smarty_tpl->tpl_vars['refund_change_info']->value['state']==0){?>
						<a href="javascript:;" class="btn" title="修改" onclick="passItemRefundChangeApply(<?php echo $_smarty_tpl->tpl_vars['refund_change_info']->value['item_refund_change_id'];?>
)">受理</a>   
						<a href="javascript:;" class="btn" title="拒绝" onclick="refuseItemRefundChangeApply(<?php echo $_smarty_tpl->tpl_vars['refund_change_info']->value['item_refund_change_id'];?>
)">拒绝</a>   
					<?php }?>
				</td>  
			</tr>
		<?php }
if (!$_smarty_tpl->tpl_vars['refund_change_info']->_loop) {
?>      
		<tr>
			<td colspan="9">
				没有符合条件的记录
...
<?php }} ?><?php /* Smarty version Smarty-3.1.6, created on 2016-08-19 17:49:50
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpOrder/Public_forms.html" */ ?>
<?php if ($_valid && !is_callable('content_57b6d63e9e061')) {function content_57b6d63e9e061($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.date_format.php';
