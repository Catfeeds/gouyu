<?php /* Smarty version Smarty-3.1.6, created on 2016-09-20 10:16:58
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpRole/add_admin.html" */ ?>
<?php /*%%SmartyHeaderCode:25688676957e09c1a4b5822-29231760%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4231b0cd8f37bff875aaf24001249d94f1eff880' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpRole/add_admin.html',
      1 => 1471252521,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '25688676957e09c1a4b5822-29231760',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57e09c1a756dd',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57e09c1a756dd')) {function content_57e09c1a756dd($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" name='linkman' value='' id='linkman' placeholder="" class="small"> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">
    	<input type="text" name='name'  id='name' value='' class="small">
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" name='mobile' value='' id='mobile' placeholder="" class="default">
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" name='tel' value='' id='tel' placeholder="" class="default">
        <span class="fi-help-text"></span>    
    </div>  
</div>
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" name='email' value='' id='email' placeholder="" class="default">
...
'><?php echo $_smarty_tpl->tpl_vars['group_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['row']['index']]['group_name'];?>
</option>	
            <?php endfor; endif; ?> 
        </select>  
    </div>  
...
' />
    	<button type="submit" class="btn btn-blue" onclick='return checkAddAdmin()'><i class="gicon-ok white"></i>保存</button>  
...
<script src="__ACPJS__/AcpUser/user_group.js?version=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"></script>
