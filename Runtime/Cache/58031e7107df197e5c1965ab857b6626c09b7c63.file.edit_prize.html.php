<?php /* Smarty version Smarty-3.1.6, created on 2016-08-18 09:36:50
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpPrize/edit_prize.html" */ ?>
<?php /*%%SmartyHeaderCode:160449194857b510d1e1ec32-78717064%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '58031e7107df197e5c1965ab857b6626c09b7c63' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpPrize/edit_prize.html',
      1 => 1471484209,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '160449194857b510d1e1ec32-78717064',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b510d205a76',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b510d205a76')) {function content_57b510d205a76($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="xlarge" name="prize_name" id="prize_name" value="<?php echo $_smarty_tpl->tpl_vars['prize_info']->value['prize_name'];?>
">  
    ...
    <div class="form-controls">
        <div  id="img_path">
            <ul class="fi-imgslist" style="float:left;">
                <li class="preview fi-imgslist-item pic<?php if (!$_smarty_tpl->tpl_vars['prize_info']->value['img_path']||!file_exists($_smarty_tpl->tpl_vars['img_path_path']->value)){?> hide<?php }?>" id="preview" style="">
                    <div>
                        <img id="J_Preview" style="height: 65px;" src="<?php echo $_smarty_tpl->tpl_vars['prize_info']->value['img_path'];?>
"/>
                    </div>
                    <input type="hidden" name="img_path" id="J_ImgUrl" data-id="<?php if ($_smarty_tpl->tpl_vars['prize_info']->value['img_path']){?><?php }?>" value="<?php echo $_smarty_tpl->tpl_vars['prize_info']->value['img_path'];?>
" />
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
		<input type="text" placeholder="" class="mini" name="serial" id="serial" value="<?php echo $_smarty_tpl->tpl_vars['prize_info']->value['serial'];?>
">  
		<span class="fi-help-text hide"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="isuse" value="1" <?php if ($_smarty_tpl->tpl_vars['prize_info']->value['isuse']==1){?>checked="checked"<?php }?> />是</label>  
            <label><input type="radio" name="isuse" value="0" <?php if ($_smarty_tpl->tpl_vars['prize_info']->value['isuse']==0){?>checked="checked"<?php }?>/>否</label>   
        </div>  
    </div>  
</div> 
