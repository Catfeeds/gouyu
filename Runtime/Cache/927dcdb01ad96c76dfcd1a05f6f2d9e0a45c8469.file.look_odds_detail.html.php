<?php /* Smarty version Smarty-3.1.6, created on 2016-10-12 10:46:52
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessChampion/look_odds_detail.html" */ ?>
<?php /*%%SmartyHeaderCode:90065782457b67454ebedd3-16560180%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '927dcdb01ad96c76dfcd1a05f6f2d9e0a45c8469' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessChampion/look_odds_detail.html',
      1 => 1476240409,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '90065782457b67454ebedd3-16560180',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b6745510a55',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b6745510a55')) {function content_57b6745510a55($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
?>
                <tr>  
					...
					<td><?php echo $_smarty_tpl->tpl_vars['item']->value['odds'];?>
</td>
					<td><?php echo $_smarty_tpl->tpl_vars['item']->value['num'];?>
</td>
					<td><?php echo $_smarty_tpl->tpl_vars['item']->value['total_money'];?>
</td>
                    <?php if (!$_smarty_tpl->tpl_vars['info']->value['is_over']){?>
                    <td><a href="javascript:;" class="btn" title="设为胜方" onclick="set_team(<?php echo $_smarty_tpl->tpl_vars['info']->value['guess_champion_id'];?>
, <?php echo $_smarty_tpl->tpl_vars['item']->value['guess_champion_team_id'];?>
)">设为冠军</a>  </td>
                    <?php }else{ ?>
                    <?php if ($_smarty_tpl->tpl_vars['item']->value['guess_champion_team_id']==$_smarty_tpl->tpl_vars['item']->value['win_team']){?>
					<td>冠军</td>
                    <?php }?>
                    <?php }?>
                </tr>  
