<?php /* Smarty version Smarty-3.1.6, created on 2016-09-18 15:32:53
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessType/list_guess_type.html" */ ?>
<?php /*%%SmartyHeaderCode:10309241657de41b44b4336-11003683%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '02284b82572358082ec2fe258173342ecfb5719c' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpGuessType/list_guess_type.html',
      1 => 1474183972,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '10309241657de41b44b4336-11003683',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57de41b470f2f',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57de41b470f2f')) {function content_57de41b470f2f($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
?>
    <tbody class="combo-tbody">  
        <tr>
			<td><input type="checkbox" class="checkbox" name="a[]" value="<?php echo $_smarty_tpl->tpl_vars['question_class']->value['guess_type_id'];?>
"></td>
			<td><?php echo $_smarty_tpl->tpl_vars['question_class']->value['guess_type_name'];?>
</td>  
            ...
            <td>  
				<a href="/AcpGuessType/edit_guess_type/guess_type_id/<?php echo $_smarty_tpl->tpl_vars['question_class']->value['guess_type_id'];?>
.html" class="btn" title="修改">修改</a>  
                <a href="javascript:;" class="btn" title="删除" onclick="delete_question_class(<?php echo $_smarty_tpl->tpl_vars['question_class']->value['guess_type_id'];?>
)">删除</a>  
            </td>  
        </tr>
    </tbody>
