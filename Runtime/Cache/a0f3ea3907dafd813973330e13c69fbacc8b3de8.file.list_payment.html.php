<?php /* Smarty version Smarty-3.1.6, created on 2016-10-28 10:18:24
         compiled from "/Users/wuzeguo/workspace/gouyu/Tpl/AcpPayment/list_payment.html" */ ?>
<?php /*%%SmartyHeaderCode:176539250357b18f773d4a85-81664871%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a0f3ea3907dafd813973330e13c69fbacc8b3de8' => 
    array (
      0 => '/Users/wuzeguo/workspace/gouyu/Tpl/AcpPayment/list_payment.html',
      1 => 1477621102,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '176539250357b18f773d4a85-81664871',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_57b18f775d629',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_57b18f775d629')) {function content_57b18f775d629($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Users/wuzeguo/workspace/gouyu/frame/Extend/Vendor/Smarty/plugins/modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="tablesWrap" style="margin-top:20px;"> 
    <table class="wxtables">  
        ...
        <tbody>  
			<?php  $_smarty_tpl->tpl_vars['payway_info'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['payway_info']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['payway_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['foo']['index']=-1;
foreach ($_from as $_smarty_tpl->tpl_vars['payway_info']->key => $_smarty_tpl->tpl_vars['payway_info']->value){
$_smarty_tpl->tpl_vars['payway_info']->_loop = true;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['foo']['index']++;
?>
                <?php if ($_smarty_tpl->tpl_vars['payway_info']->value['pay_tag']=='wxpay'||$_smarty_tpl->tpl_vars['payway_info']->value['pay_tag']=='wap_alipay'){?>
				<tr>  
					<td>  
                        <?php if ($_smarty_tpl->tpl_vars['payway_info']->value['pay_tag']=='wxpay'){?>
                        1
                        <?php }else{ ?>
                        2
                        <?php }?>
...
.
					...
					<td>  
						<?php echo $_smarty_tpl->tpl_vars['payway_info']->value['pay_name'];?>

						<?php if ($_smarty_tpl->tpl_vars['payway_info']->value['pay_tag']=='alipay'||$_smarty_tpl->tpl_vars['payway_info']->value['pay_tag']=='wap_alipay'){?>
							<a href="http://bizpartner.alipay.com/360shop/" style="font-size:14px;font-weight:700;color:red;" target="_blank">免费签约>></a>
						<?php }elseif($_smarty_tpl->tpl_vars['payway_info']->value['pay_tag']=='chinabank'){?>
							<a href="http://www.chinabank.com.cn/gateway/foropening.html" style="font-size:14px;font-weight:700;color:red;" target="_blank">去签约>></a>
						<?php }?>
					</td>
					<td>  
						<?php echo $_smarty_tpl->tpl_vars['payway_info']->value['pay_desc'];?>

					</td>  
					<td> 
						<?php if ($_smarty_tpl->tpl_vars['payway_info']->value['isuse']==0){?>
							未开启使用
						<?php }else{ ?>
							正在使用中
						<?php }?>
					...
					<td>  
						<?php if ($_smarty_tpl->tpl_vars['payway_info']->value['pay_tag']=='wxpay'){?>
						<a href="/AcpPayment/set_wxpay" class="btn" title="设置">设置</a> 
                        <?php }?>
						<?php if ($_smarty_tpl->tpl_vars['payway_info']->value['pay_tag']=='alipay'){?>
						<a href="/AcpPayment/set_alipay" class="btn" title="设置">设置</a> 
                        <?php }?>
						<?php if ($_smarty_tpl->tpl_vars['payway_info']->value['pay_tag']=='wap_alipay'){?>
						<a href="/AcpPayment/set_mobile_wap_alipay" class="btn" title="设置">设置</a> 
                        <?php }?>
						<!-- a href="javascript:;" class="btn" title="支付说明">支付说明</a -->  
					</td>
				</tr> 
                <?php }?>
			<?php } ?>
